...
public class Arith extends Base {
    ...
    public void arith32(FileOutputStream fos, FileOutputStream fos_init, FileOutputStream fos32, String name, String op, boolean cf, boolean result, String bits, boolean flags, boolean iform, boolean hasRE)  throws IOException {
        ...
        String dyn;
        if (result) {
            dyn = "if (!op->needsToSetFlags()) {\r\n        movToRegFromCpu(DYN_SRC, offsetof(CPU, reg[op->rm].u32), DYN_32bit);\r\n        "+(cf?"instRegReg('+', DYN_SRC, DYN_CALL_RESULT, DYN_32bit);\r\n        ":"")+"instCPUReg('" + op + "', offsetof(CPU, reg[op->reg].u32), DYN_SRC, DYN_32bit);\r\n    } else {\r\n        movToCpuFromCpu(offsetof(CPU, src.u32), offsetof(CPU, reg[op->rm].u32), DYN_32bit, DYN_SRC);\r\n        movToCpuFromCpu(offsetof(CPU, dst.u32), offsetof(CPU, reg[op->reg].u32), DYN_32bit, DYN_DEST);\r\n        instRegReg(\'" + op + "\', DYN_DEST, DYN_SRC, DYN_32bit);\r\n" + (cf ? "        instRegReg(\'" + op + "\', DYN_DEST, DYN_CALL_RESULT, DYN_32bit);\r\n" : "") + "        movToCpuFromReg(offsetof(CPU, result.u32), DYN_DEST, DYN_32bit);" + (result ? "\r\n        movToCpuFromReg(offsetof(CPU, reg[op->reg].u32), DYN_DEST, DYN_32bit);" : "")+(flags?"\r\n        movToCpu(offsetof(CPU, lazyFlags), Dyn_PtrSize, (DYN_PTR_SIZE)" + "FLAGS_"+name.toUpperCase()+bits + ");":"")+"\r\n    }";
        } else {
            dyn = "movToCpuFromCpu(offsetof(CPU, src.u32), offsetof(CPU, reg[op->rm].u32), DYN_32bit, DYN_SRC);\r\n    movToCpuFromCpu(offsetof(CPU, dst.u32), offsetof(CPU, reg[op->reg].u32), DYN_32bit, DYN_DEST);\r\n    instRegReg(\'" + op + "\', DYN_DEST, DYN_SRC, DYN_32bit);\r\n" + (cf ? "    instRegReg(\'" + op + "\', DYN_DEST, DYN_CALL_RESULT, DYN_32bit);\r\n" : "") + "    movToCpuFromReg(offsetof(CPU, result.u32), DYN_DEST, DYN_32bit);" + (result ? "\r\n    movToCpuFromReg(offsetof(CPU, reg[op->reg].u32), DYN_DEST, DYN_32bit);" : "")+(flags?"\r\n    movToCpu(offsetof(CPU, lazyFlags), Dyn_PtrSize, (DYN_PTR_SIZE)" + "FLAGS_"+name.toUpperCase()+bits + ");":"");
        }
        arithbase(fos, fos_init, fos32, mixed + "R32R32", name + "r32r32", "FLAGS_" + name.toUpperCase() + bits, "cpu->reg[op->rm].u32", "cpu->reg[op->reg].u32", "cpu->reg[op->reg].u32 = ", "", op, cf, result, false, bits, flags, dyn, "", false);

        if (result) {
            dyn = "if (!op->needsToSetFlags()) {\r\n        calculateEaa(op, DYN_ADDRESS);\r\n        movToRegFromCpu(DYN_SRC, offsetof(CPU, reg[op->reg].u32), DYN_32bit);\r\n        "+(cf?"instRegReg('+', DYN_SRC, DYN_CALL_RESULT, DYN_32bit);\r\n        ":"")+"instMemReg('" + op + "', DYN_ADDRESS, DYN_SRC, DYN_32bit);\r\n    } else {\r\n        movToCpuFromCpu(offsetof(CPU, src.u32), offsetof(CPU, reg[op->reg].u32), DYN_32bit, DYN_SRC);\r\n        calculateEaa(op, DYN_ADDRESS);\r\n        movToCpuFromMem(offsetof(CPU, dst.u32), DYN_32bit, DYN_ADDRESS);\r\n        instRegReg(\'" + op + "\', DYN_READ_RESULT, DYN_SRC, DYN_32bit);\r\n" + (cf ? "        movToRegFromCpu(DYN_SRC, offsetof(CPU, oldCF), DYN_32bit);\r\n        instRegReg(\'" + op + "\', DYN_READ_RESULT, DYN_SRC, DYN_32bit);\r\n" : "") + "        movToCpuFromReg(offsetof(CPU, result.u32), DYN_READ_RESULT, DYN_32bit);\r\n        movToMemFromReg(DYN_ADDRESS, DYN_READ_RESULT, DYN_32bit);"+(flags?"\r\n        movToCpu(offsetof(CPU, lazyFlags), Dyn_PtrSize, (DYN_PTR_SIZE)" + "FLAGS_"+name.toUpperCase()+bits + ");":"")+"\r\n    }";
        } else {
            dyn = "movToCpuFromCpu(offsetof(CPU, src.u32), offsetof(CPU, reg[op->reg].u32), DYN_32bit, DYN_SRC);\r\n    calculateEaa(op, DYN_ADDRESS);\r\n    movToCpuFromMem(offsetof(CPU, dst.u32), DYN_32bit, DYN_ADDRESS);\r\n    instRegReg(\'" + op + "\', DYN_READ_RESULT, DYN_SRC, DYN_32bit);\r\n" + (cf ? "    movToRegFromCpu(DYN_SRC, offsetof(CPU, oldCF), DYN_32bit);\r\n    instRegReg(\'" + op + "\', DYN_READ_RESULT, DYN_SRC, DYN_32bit);\r\n" : "") + "    movToCpuFromReg(offsetof(CPU, result.u32), DYN_READ_RESULT, DYN_32bit);" + (result ? "\r\n    movToMemFromReg(DYN_ADDRESS, DYN_READ_RESULT, DYN_32bit);" : "")+(flags?"\r\n    movToCpu(offsetof(CPU, lazyFlags), Dyn_PtrSize, (DYN_PTR_SIZE)" + "FLAGS_"+name.toUpperCase()+bits + ");":"");
        }
        arithbase(fos, fos_init, fos32, mixed + "E32R32", name + "e32r32", "FLAGS_" + name.toUpperCase() + bits, "cpu->reg[op->reg].u32", "readd(eaa)", "writed(eaa, ", ")", op, cf, result, true, bits, flags, dyn, "", false);
        if (hasRE) {
            if (result) {
                dyn = "if (!op->needsToSetFlags()) {\r\n        calculateEaa(op, DYN_ADDRESS);\r\n        "+(cf?"movToRegFromCpu(DYN_DEST, offsetof(CPU, reg[op->reg].u32), DYN_32bit);\r\n        instRegReg('" + op + "', DYN_DEST, DYN_CALL_RESULT, DYN_32bit);\r\n        movFromMem(DYN_32bit, DYN_ADDRESS);\r\n        instRegReg('" + op + "', DYN_DEST, DYN_READ_RESULT, DYN_32bit);\r\n        movToCpuFromReg(offsetof(CPU, reg[op->reg].u32), DYN_DEST, DYN_32bit);":"movFromMem(DYN_32bit, DYN_ADDRESS);\r\n        instCPUReg('" + op + "', offsetof(CPU, reg[op->reg].u32), DYN_READ_RESULT, DYN_32bit);")+"\r\n    } else {\r\n        calculateEaa(op, DYN_ADDRESS);\r\n        movToCpuFromMem(offsetof(CPU, src.u32), DYN_32bit, DYN_ADDRESS);\r\n        movToCpuFromCpu(offsetof(CPU, dst.u32), offsetof(CPU, reg[op->reg].u32), DYN_32bit, DYN_DEST);\r\n        instRegReg(\'" + op + "\', DYN_DEST, DYN_READ_RESULT, DYN_32bit);\r\n"+(cf?"        movToRegFromCpu(DYN_SRC, offsetof(CPU, oldCF), DYN_32bit);\r\n        instRegReg(\'" + op + "\', DYN_DEST, DYN_SRC, DYN_32bit);\r\n":"")+"        movToCpuFromReg(offsetof(CPU, result.u32), DYN_DEST, DYN_32bit);\r\n        movToCpuFromReg(offsetof(CPU, reg[op->reg].u32), DYN_DEST, DYN_32bit);"+(flags?"\r\n        movToCpu(offsetof(CPU, lazyFlags), Dyn_PtrSize, (DYN_PTR_SIZE)" + "FLAGS_"+name.toUpperCase()+bits + ");":"")+"\r\n    }";
            } else {
                dyn = "calculateEaa(op, DYN_ADDRESS);\r\n    movToCpuFromMem(offsetof(CPU, src.u32), DYN_32bit, DYN_ADDRESS);\r\n    movToCpuFromCpu(offsetof(CPU, dst.u32), offsetof(CPU, reg[op->reg].u32), DYN_32bit, DYN_DEST);\r\n    instRegReg(\'" + op + "\', DYN_DEST, DYN_READ_RESULT, DYN_32bit);\r\n"+(cf?"    movToRegFromCpu(DYN_SRC, offsetof(CPU, oldCF), DYN_32bit);\r\n    instRegReg(\'" + op + "\', DYN_DEST, DYN_SRC, DYN_32bit);\r\n":"")+"    movToCpuFromReg(offsetof(CPU, result.u32), DYN_DEST, DYN_32bit);"+(result?"\r\n    movToCpuFromReg(offsetof(CPU, reg[op->reg].u32), DYN_DEST, DYN_32bit);":"")+(flags?"\r\n    movToCpu(offsetof(CPU, lazyFlags), Dyn_PtrSize, (DYN_PTR_SIZE)" + "FLAGS_"+name.toUpperCase()+bits + ");":"");
            }
            arithbase(fos, fos_init, fos32, mixed + "R32E32", name + "r32e32", "FLAGS_" + name.toUpperCase() + bits, "readd(eaa(cpu, op))", "cpu->reg[op->reg].u32", "cpu->reg[op->reg].u32 = ", "", op, cf, result, false, bits, flags, dyn, "", false);
        }
        if (iform) {
            if (result) {
                dyn = "if (!op->needsToSetFlags()) {\r\n        "+(cf?"instRegImm('+', DYN_CALL_RESULT, DYN_32bit, op->imm);\r\n        instCPUReg('"+op+"', offsetof(CPU, reg[op->reg].u32), DYN_CALL_RESULT, DYN_32bit);":"instCPUImm('" + op + "', offsetof(CPU, reg[op->reg].u32), DYN_32bit, op->imm);")+"\r\n    } else {\r\n        movToCpu(offsetof(CPU, src.u32), DYN_32bit, op->imm);\r\n        movToCpuFromCpu(offsetof(CPU, dst.u32), offsetof(CPU, reg[op->reg].u32), DYN_32bit, DYN_DEST);\r\n        instRegImm('" + op + "', DYN_DEST, DYN_32bit, op->imm);\r\n"+(cf?"        instRegReg(\'" + op + "\', DYN_DEST, DYN_CALL_RESULT, DYN_32bit);\r\n":"")+"        movToCpuFromReg(offsetof(CPU, result.u32), DYN_DEST, DYN_32bit);\r\n        movToCpuFromReg(offsetof(CPU, reg[op->reg].u32), DYN_DEST, DYN_32bit);"+(flags?"\r\n        movToCpu(offsetof(CPU, lazyFlags), Dyn_PtrSize, (DYN_PTR_SIZE)" + "FLAGS_"+name.toUpperCase()+bits + ");":"")+"\r\n    }";
            } else {
                dyn = "movToCpu(offsetof(CPU, src.u32), DYN_32bit, op->imm);\r\n    movToCpuFromCpu(offsetof(CPU, dst.u32), offsetof(CPU, reg[op->reg].u32), DYN_32bit, DYN_DEST);\r\n    instRegImm(\'" + op + "\', DYN_DEST, DYN_32bit, op->imm);\r\n"+(cf?"    instRegReg(\'" + op + "\', DYN_DEST, DYN_CALL_RESULT, DYN_32bit);\r\n":"")+"    movToCpuFromReg(offsetof(CPU, result.u32), DYN_DEST, DYN_32bit);"+(result?"\r\n    movToCpuFromReg(offsetof(CPU, reg[op->reg].u32), DYN_DEST, DYN_32bit);":"")+(flags?"\r\n    movToCpu(offsetof(CPU, lazyFlags), Dyn_PtrSize, (DYN_PTR_SIZE)" + "FLAGS_"+name.toUpperCase()+bits + ");":"");
            }
            arithbase(fos, fos_init, fos32, mixed + "R32I32", name + "32_reg", "FLAGS_" + name.toUpperCase() + bits, "op->imm", "cpu->reg[op->reg].u32", "cpu->reg[op->reg].u32 = ", "", op, cf, result, false, bits, flags, dyn, "", false);

            if (result && !cf) {
                dyn = "if (!op->needsToSetFlags()) {\r\n        calculateEaa(op, DYN_ADDRESS);\r\n        "+(cf?"instRegImm('+', DYN_CALL_RESULT, DYN_32bit, op->imm);\r\n        instMemReg('"+op+"', DYN_ADDRESS, DYN_CALL_RESULT, DYN_32bit);":"instMemImm('"+op+"', DYN_ADDRESS, DYN_32bit, op->imm);")+"\r\n    } else {\r\n        movToCpu(offsetof(CPU, src.u32), DYN_32bit, op->imm);\r\n        calculateEaa(op, DYN_ADDRESS);\r\n        movToCpuFromMem(offsetof(CPU, dst.u32), DYN_32bit, DYN_ADDRESS);\r\n        instRegImm(\'" + op + "\', DYN_READ_RESULT, DYN_32bit, op->imm);\r\n"+(cf?"        movToRegFromCpu(DYN_SRC, offsetof(CPU, oldCF), DYN_32bit);\r\n        instRegReg(\'" + op + "\', DYN_READ_RESULT, DYN_SRC, DYN_32bit);\r\n":"")+"        movToCpuFromReg(offsetof(CPU, result.u32), DYN_READ_RESULT, DYN_32bit);\r\n        movToMemFromReg(DYN_ADDRESS, DYN_READ_RESULT, DYN_32bit);"+(flags?"\r\n        movToCpu(offsetof(CPU, lazyFlags), Dyn_PtrSize, (DYN_PTR_SIZE)" + "FLAGS_"+name.toUpperCase()+bits + ");":"")+"\r\n    }";
            } else {
                dyn = "movToCpu(offsetof(CPU, src.u32), DYN_32bit, op->imm);\r\n    calculateEaa(op, DYN_ADDRESS);\r\n    movToCpuFromMem(offsetof(CPU, dst.u32), DYN_32bit, DYN_ADDRESS);\r\n    instRegImm(\'" + op + "\', DYN_READ_RESULT, DYN_32bit, op->imm);\r\n"+(cf?"    movToRegFromCpu(DYN_SRC, offsetof(CPU, oldCF), DYN_32bit);\r\n    instRegReg(\'" + op + "\', DYN_READ_RESULT, DYN_SRC, DYN_32bit);\r\n":"")+"    movToCpuFromReg(offsetof(CPU, result.u32), DYN_READ_RESULT, DYN_32bit);"+(result?"\r\n    movToMemFromReg(DYN_ADDRESS, DYN_READ_RESULT, DYN_32bit);":"")+(flags?"\r\n    movToCpu(offsetof(CPU, lazyFlags), Dyn_PtrSize, (DYN_PTR_SIZE)" + "FLAGS_"+name.toUpperCase()+bits + ");":"");
            }
            arithbase(fos, fos_init, fos32, mixed + "E32I32", name + "32_mem", "FLAGS_" + name.toUpperCase() + bits, "op->imm", "readd(eaa)", "writed(eaa, ", ")", op, cf, result, true, bits, flags, dyn, "", false);
        }
    }
    ...
    public void arith16(FileOutputStream fos, FileOutputStream fos_init, FileOutputStream fos32, String name, String op, boolean cf, boolean result, String bits, boolean flags, boolean iform, boolean hasRE)  throws IOException {
        ...
        String dyn;
        if (result) {
            dyn = "if (!op->needsToSetFlags()) {\r\n        movToRegFromCpu(DYN_SRC, offsetof(CPU, reg[op->rm].u16), DYN_16bit);\r\n        "+(cf?"movToRegFromReg(DYN_CALL_RESULT, DYN_16bit, DYN_CALL_RESULT, DYN_32bit);\r\n        instRegReg('+', DYN_SRC, DYN_CALL_RESULT, DYN_16bit);\r\n        ":"")+"instCPUReg('" + op + "', offsetof(CPU, reg[op->reg].u16), DYN_SRC, DYN_16bit);\r\n    } else {\r\n        movToCpuFromCpu(offsetof(CPU, src.u16), offsetof(CPU, reg[op->rm].u16), DYN_16bit, DYN_SRC);\r\n        movToCpuFromCpu(offsetof(CPU, dst.u16), offsetof(CPU, reg[op->reg].u16), DYN_16bit, DYN_DEST);\r\n        instRegReg(\'" + op + "\', DYN_DEST, DYN_SRC, DYN_16bit);\r\n" + (cf ? "        movToRegFromReg(DYN_CALL_RESULT, DYN_16bit, DYN_CALL_RESULT, DYN_32bit);\r\n        instRegReg(\'" + op + "\', DYN_DEST, DYN_CALL_RESULT, DYN_16bit);\r\n" : "") + "        movToCpuFromReg(offsetof(CPU, result.u16), DYN_DEST, DYN_16bit);" + (result ? "\r\n        movToCpuFromReg(offsetof(CPU, reg[op->reg].u16), DYN_DEST, DYN_16bit);" : "")+(flags?"\r\n        movToCpu(offsetof(CPU, lazyFlags), Dyn_PtrSize, (DYN_PTR_SIZE)" + "FLAGS_"+name.toUpperCase()+bits + ");":"")+"\r\n    }";
        } else {
            dyn = "movToCpuFromCpu(offsetof(CPU, src.u16), offsetof(CPU, reg[op->rm].u16), DYN_16bit, DYN_SRC);\r\n    movToCpuFromCpu(offsetof(CPU, dst.u16), offsetof(CPU, reg[op->reg].u16), DYN_16bit, DYN_DEST);\r\n    instRegReg(\'" + op + "\', DYN_DEST, DYN_SRC, DYN_16bit);\r\n" + (cf ? "    movToRegFromReg(DYN_CALL_RESULT, DYN_16bit, DYN_CALL_RESULT, DYN_32bit);\r\n    instRegReg(\'" + op + "\', DYN_DEST, DYN_CALL_RESULT, DYN_16bit);\r\n" : "") + "    movToCpuFromReg(offsetof(CPU, result.u16), DYN_DEST, DYN_16bit);" + (result ? "\r\n    movToCpuFromReg(offsetof(CPU, reg[op->reg].u16), DYN_DEST, DYN_16bit);" : "")+(flags?"\r\n    movToCpu(offsetof(CPU, lazyFlags), Dyn_PtrSize, (DYN_PTR_SIZE)" + "FLAGS_"+name.toUpperCase()+bits + ");":"");
        }
        arithbase(fos, fos_init, fos32, mixed + "R16R16", name+"r16r16", "FLAGS_"+name.toUpperCase()+bits, "cpu->reg[op->rm].u16", "cpu->reg[op->reg].u16", "cpu->reg[op->reg].u16 = ", "", op, cf, result, false, bits, flags, dyn, "", false);

        if (result) {
            dyn = "if (!op->needsToSetFlags()) {\r\n        calculateEaa(op, DYN_ADDRESS);\r\n        movToRegFromCpu(DYN_SRC, offsetof(CPU, reg[op->reg].u16), DYN_16bit);\r\n        "+(cf?"movToRegFromReg(DYN_CALL_RESULT, DYN_16bit, DYN_CALL_RESULT, DYN_32bit);\r\n        instRegReg('+', DYN_SRC, DYN_CALL_RESULT, DYN_16bit);\r\n        ":"")+"instMemReg('" + op + "', DYN_ADDRESS, DYN_SRC, DYN_16bit);\r\n    } else {\r\n        movToCpuFromCpu(offsetof(CPU, src.u16), offsetof(CPU, reg[op->reg].u16), DYN_16bit, DYN_SRC);\r\n        calculateEaa(op, DYN_ADDRESS);\r\n        movToCpuFromMem(offsetof(CPU, dst.u16), DYN_16bit, DYN_ADDRESS);\r\n        instRegReg(\'" + op + "\', DYN_READ_RESULT, DYN_SRC, DYN_16bit);\r\n" + (cf ? "        movToRegFromCpu(DYN_SRC, offsetof(CPU, oldCF), DYN_32bit);\r\n        movToRegFromReg(DYN_SRC, DYN_16bit, DYN_SRC, DYN_32bit);\r\n        instRegReg(\'" + op + "\', DYN_READ_RESULT, DYN_SRC, DYN_16bit);\r\n" : "") + "        movToCpuFromReg(offsetof(CPU, result.u16), DYN_READ_RESULT, DYN_16bit);\r\n        movToMemFromReg(DYN_ADDRESS, DYN_READ_RESULT, DYN_16bit);"+(flags?"\r\n        movToCpu(offsetof(CPU, lazyFlags), Dyn_PtrSize, (DYN_PTR_SIZE)" + "FLAGS_"+name.toUpperCase()+bits + ");":"")+"\r\n    }";
        } else {
            dyn = "movToCpuFromCpu(offsetof(CPU, src.u16), offsetof(CPU, reg[op->reg].u16), DYN_16bit, DYN_SRC);\r\n    calculateEaa(op, DYN_ADDRESS);\r\n    movToCpuFromMem(offsetof(CPU, dst.u16), DYN_16bit, DYN_ADDRESS);\r\n    instRegReg(\'" + op + "\', DYN_READ_RESULT, DYN_SRC, DYN_16bit);\r\n" + (cf ? "    movToRegFromCpu(DYN_SRC, offsetof(CPU, oldCF), DYN_32bit);\r\n    movToRegFromReg(DYN_SRC, DYN_16bit, DYN_SRC, DYN_32bit);\r\n    instRegReg(\'" + op + "\', DYN_READ_RESULT, DYN_SRC, DYN_16bit);\r\n" : "") + "    movToCpuFromReg(offsetof(CPU, result.u16), DYN_READ_RESULT, DYN_16bit);" + (result ? "\r\n    movToMemFromReg(DYN_ADDRESS, DYN_READ_RESULT, DYN_16bit);" : "")+(flags?"\r\n    movToCpu(offsetof(CPU, lazyFlags), Dyn_PtrSize, (DYN_PTR_SIZE)" + "FLAGS_"+name.toUpperCase()+bits + ");":"");
        }
        arithbase(fos, fos_init, fos32, mixed + "E16R16", name+"e16r16", "FLAGS_"+name.toUpperCase()+bits, "cpu->reg[op->reg].u16", "readw(eaa)", "writew(eaa, ", ")", op, cf, result, true, bits, flags, dyn, "", false);

        if (hasRE) {
            if (result) {
                dyn = "if (!op->needsToSetFlags()) {\r\n        calculateEaa(op, DYN_ADDRESS);\r\n        "+(cf?"movToRegFromCpu(DYN_DEST, offsetof(CPU, reg[op->reg].u16), DYN_16bit);\r\n        movToRegFromReg(DYN_CALL_RESULT, DYN_16bit, DYN_CALL_RESULT, DYN_32bit);\r\n        instRegReg('" + op + "', DYN_DEST, DYN_CALL_RESULT, DYN_16bit);\r\n        movFromMem(DYN_16bit, DYN_ADDRESS);\r\n        instRegReg('" + op + "', DYN_DEST, DYN_READ_RESULT, DYN_16bit);\r\n        movToCpuFromReg(offsetof(CPU, reg[op->reg].u16), DYN_DEST, DYN_16bit);":"movFromMem(DYN_16bit, DYN_ADDRESS);\r\n        instCPUReg('" + op + "', offsetof(CPU, reg[op->reg].u16), DYN_READ_RESULT, DYN_16bit);")+"\r\n    } else {\r\n        calculateEaa(op, DYN_ADDRESS);\r\n        movToCpuFromMem(offsetof(CPU, src.u16), DYN_16bit, DYN_ADDRESS);\r\n        movToCpuFromCpu(offsetof(CPU, dst.u16), offsetof(CPU, reg[op->reg].u16), DYN_16bit, DYN_DEST);\r\n        instRegReg(\'" + op + "\', DYN_DEST, DYN_READ_RESULT, DYN_16bit);\r\n" + (cf ? "        movToRegFromCpu(DYN_SRC, offsetof(CPU, oldCF), DYN_32bit);\r\n        movToRegFromReg(DYN_SRC, DYN_16bit, DYN_SRC, DYN_32bit);\r\n        instRegReg(\'" + op + "\', DYN_DEST, DYN_SRC, DYN_16bit);\r\n" : "") + "        movToCpuFromReg(offsetof(CPU, result.u16), DYN_DEST, DYN_16bit);\r\n        movToCpuFromReg(offsetof(CPU, reg[op->reg].u16), DYN_DEST, DYN_16bit);"+(flags?"\r\n        movToCpu(offsetof(CPU, lazyFlags), Dyn_PtrSize, (DYN_PTR_SIZE)" + "FLAGS_"+name.toUpperCase()+bits + ");":"")+"\r\n    }";
            } else {
                dyn = "calculateEaa(op, DYN_ADDRESS);\r\n    movToCpuFromMem(offsetof(CPU, src.u16), DYN_16bit, DYN_ADDRESS);\r\n    movToCpuFromCpu(offsetof(CPU, dst.u16), offsetof(CPU, reg[op->reg].u16), DYN_16bit, DYN_DEST);\r\n    instRegReg(\'" + op + "\', DYN_DEST, DYN_READ_RESULT, DYN_16bit);\r\n" + (cf ? "    movToRegFromCpu(DYN_SRC, offsetof(CPU, oldCF), DYN_32bit);\r\n    movToRegFromReg(DYN_SRC, DYN_16bit, DYN_SRC, DYN_32bit);\r\n    instRegReg(\'" + op + "\', DYN_DEST, DYN_SRC, DYN_16bit);\r\n" : "") + "    movToCpuFromReg(offsetof(CPU, result.u16), DYN_DEST, DYN_16bit);" + (result ? "\r\n    movToCpuFromReg(offsetof(CPU, reg[op->reg].u16), DYN_DEST, DYN_16bit);" : "")+(flags?"\r\n    movToCpu(offsetof(CPU, lazyFlags), Dyn_PtrSize, (DYN_PTR_SIZE)" + "FLAGS_"+name.toUpperCase()+bits + ");":"");
            }
            arithbase(fos, fos_init, fos32, mixed + "R16E16", name + "r16e16", "FLAGS_" + name.toUpperCase() + bits, "readw(eaa(cpu, op))", "cpu->reg[op->reg].u16", "cpu->reg[op->reg].u16 = ", "", op, cf, result, false, bits, flags, dyn, "", false);
        }
        if (iform) {
            if (result) {
                dyn = "if (!op->needsToSetFlags()) {\r\n        "+(cf?"movToRegFromReg(DYN_CALL_RESULT, DYN_16bit, DYN_CALL_RESULT, DYN_32bit);\r\n        instRegImm('+', DYN_CALL_RESULT, DYN_16bit, op->imm);\r\n        instCPUReg('"+op+"', offsetof(CPU, reg[op->reg].u16), DYN_CALL_RESULT, DYN_16bit);":"instCPUImm('" + op + "', offsetof(CPU, reg[op->reg].u16), DYN_16bit, op->imm);")+"\r\n    } else {\r\n        movToCpu(offsetof(CPU, src.u16), DYN_16bit, op->imm);\r\n        movToCpuFromCpu(offsetof(CPU, dst.u16), offsetof(CPU, reg[op->reg].u16), DYN_16bit, DYN_DEST);\r\n        instRegImm(\'" + op + "\', DYN_DEST, DYN_16bit, op->imm);\r\n" + (cf ? "        movToRegFromReg(DYN_CALL_RESULT, DYN_16bit, DYN_CALL_RESULT, DYN_32bit);\r\n        instRegReg(\'" + op + "\', DYN_DEST, DYN_CALL_RESULT, DYN_16bit);\r\n" : "") + "        movToCpuFromReg(offsetof(CPU, result.u16), DYN_DEST, DYN_16bit);\r\n        movToCpuFromReg(offsetof(CPU, reg[op->reg].u16), DYN_DEST, DYN_16bit);"+(flags?"\r\n        movToCpu(offsetof(CPU, lazyFlags), Dyn_PtrSize, (DYN_PTR_SIZE)" + "FLAGS_"+name.toUpperCase()+bits + ");":"")+"\r\n    }";
            } else {
                dyn = "movToCpu(offsetof(CPU, src.u16), DYN_16bit, op->imm);\r\n    movToCpuFromCpu(offsetof(CPU, dst.u16), offsetof(CPU, reg[op->reg].u16), DYN_16bit, DYN_DEST);\r\n    instRegImm(\'" + op + "\', DYN_DEST, DYN_16bit, op->imm);\r\n" + (cf ? "    movToRegFromReg(DYN_CALL_RESULT, DYN_16bit, DYN_CALL_RESULT, DYN_32bit);\r\n    instRegReg(\'" + op + "\', DYN_DEST, DYN_CALL_RESULT, DYN_16bit);\r\n" : "") + "    movToCpuFromReg(offsetof(CPU, result.u16), DYN_DEST, DYN_16bit);" + (result ? "\r\n    movToCpuFromReg(offsetof(CPU, reg[op->reg].u16), DYN_DEST, DYN_16bit);" : "")+(flags?"\r\n    movToCpu(offsetof(CPU, lazyFlags), Dyn_PtrSize, (DYN_PTR_SIZE)" + "FLAGS_"+name.toUpperCase()+bits + ");":"");
            }
            arithbase(fos, fos_init, fos32, mixed + "R16I16", name + "16_reg", "FLAGS_" + name.toUpperCase() + bits, "op->imm", "cpu->reg[op->reg].u16", "cpu->reg[op->reg].u16 = ", "", op, cf, result, false, bits, flags, dyn, "", false);

            if (result) {
                dyn = "if (!op->needsToSetFlags()) {\r\n        calculateEaa(op, DYN_ADDRESS);\r\n        "+(cf?"movToRegFromReg(DYN_CALL_RESULT, DYN_16bit, DYN_CALL_RESULT, DYN_32bit);\r\n          instRegImm('+', DYN_CALL_RESULT, DYN_16bit, op->imm);\r\n        instMemReg('"+op+"', DYN_ADDRESS, DYN_CALL_RESULT, DYN_16bit);":"instMemImm('"+op+"', DYN_ADDRESS, DYN_16bit, op->imm);")+"\r\n    } else {\r\n        movToCpu(offsetof(CPU, src.u16), DYN_16bit, op->imm);\r\n        calculateEaa(op, DYN_ADDRESS);\r\n        movToCpuFromMem(offsetof(CPU, dst.u16), DYN_16bit, DYN_ADDRESS);\r\n        instRegImm('" + op + "', DYN_READ_RESULT, DYN_16bit, op->imm);\r\n"+(cf?"        movToRegFromCpu(DYN_SRC, offsetof(CPU, oldCF), DYN_32bit);\r\n        movToRegFromReg(DYN_SRC, DYN_16bit, DYN_SRC, DYN_32bit);\r\n        instRegReg(\'" + op + "\', DYN_READ_RESULT, DYN_SRC, DYN_16bit);\r\n":"")+"        movToCpuFromReg(offsetof(CPU, result.u16), DYN_READ_RESULT, DYN_16bit);\r\n        movToMemFromReg(DYN_ADDRESS, DYN_READ_RESULT, DYN_16bit);"+(flags?"\r\n        movToCpu(offsetof(CPU, lazyFlags), Dyn_PtrSize, (DYN_PTR_SIZE)" + "FLAGS_"+name.toUpperCase()+bits + ");":"")+"\r\n    }";
            } else {
                dyn = "movToCpu(offsetof(CPU, src.u16), DYN_16bit, op->imm);\r\n    calculateEaa(op, DYN_ADDRESS);\r\n    movToCpuFromMem(offsetof(CPU, dst.u16), DYN_16bit, DYN_ADDRESS);\r\n    instRegImm(\'" + op + "\', DYN_READ_RESULT, DYN_16bit, op->imm);\r\n"+(cf?"    movToRegFromCpu(DYN_SRC, offsetof(CPU, oldCF), DYN_32bit);\r\n    movToRegFromReg(DYN_SRC, DYN_16bit, DYN_SRC, DYN_32bit);\r\n    instRegReg(\'" + op + "\', DYN_READ_RESULT, DYN_SRC, DYN_16bit);\r\n":"")+"    movToCpuFromReg(offsetof(CPU, result.u16), DYN_READ_RESULT, DYN_16bit);"+(result?"\r\n    movToMemFromReg(DYN_ADDRESS, DYN_READ_RESULT, DYN_16bit);":"")+(flags?"\r\n    movToCpu(offsetof(CPU, lazyFlags), Dyn_PtrSize, (DYN_PTR_SIZE)" + "FLAGS_"+name.toUpperCase()+bits + ");":"");
            }
            arithbase(fos, fos_init, fos32, mixed + "E16I16", name + "16_mem", "FLAGS_" + name.toUpperCase() + bits, "op->imm", "readw(eaa)", "writew(eaa, ", ")", op, cf, result, true, bits, flags, dyn,"", false);
        }
    }
    ...
    public void arith8(FileOutputStream fos, FileOutputStream fos_init, FileOutputStream fos32, String name, String op, boolean cf, boolean result, String bits, boolean flags, boolean iform, boolean hasRE)  throws IOException {
        ...
        String dyn;
        if (result) {
            dyn = "if (!op->needsToSetFlags()) {\r\n        movToRegFromCpu(DYN_SRC, OFFSET_REG8(op->rm), DYN_8bit);\r\n        "+(cf?"movToRegFromReg(DYN_CALL_RESULT, DYN_8bit, DYN_CALL_RESULT, DYN_32bit);\r\n        instRegReg('+', DYN_SRC, DYN_CALL_RESULT, DYN_8bit);\r\n        ":"")+"instCPUReg(\'" + op + "\', OFFSET_REG8(op->reg), DYN_SRC, DYN_8bit);\r\n    } else {\r\n        movToCpuFromCpu(offsetof(CPU, src.u8), OFFSET_REG8(op->rm), DYN_8bit, DYN_SRC);\r\n        movToCpuFromCpu(offsetof(CPU, dst.u8), OFFSET_REG8(op->reg), DYN_8bit, DYN_DEST);\r\n        instRegReg(\'" + op + "\', DYN_DEST, DYN_SRC, DYN_8bit);\r\n" + (cf ? "        movToRegFromReg(DYN_CALL_RESULT, DYN_8bit, DYN_CALL_RESULT, DYN_32bit);\r\n        instRegReg(\'" + op + "\', DYN_DEST, DYN_CALL_RESULT, DYN_8bit);\r\n" : "") + "        movToCpuFromReg(offsetof(CPU, result.u8), DYN_DEST, DYN_8bit);" + (result ? "\r\n        movToCpuFromReg(OFFSET_REG8(op->reg), DYN_DEST, DYN_8bit);" : "")+(flags?"\r\n        movToCpu(offsetof(CPU, lazyFlags), Dyn_PtrSize, (DYN_PTR_SIZE)" + "FLAGS_"+name.toUpperCase()+bits + ");":"")+"\r\n    }";
        } else {
            dyn = "movToCpuFromCpu(offsetof(CPU, src.u8), OFFSET_REG8(op->rm), DYN_8bit, DYN_SRC);\r\n    movToCpuFromCpu(offsetof(CPU, dst.u8), OFFSET_REG8(op->reg), DYN_8bit, DYN_DEST);\r\n    instRegReg(\'" + op + "\', DYN_DEST, DYN_SRC, DYN_8bit);\r\n" + (cf ? "    movToRegFromReg(DYN_CALL_RESULT, DYN_8bit, DYN_CALL_RESULT, DYN_32bit);\r\n    instRegReg(\'" + op + "\', DYN_DEST, DYN_CALL_RESULT, DYN_8bit);\r\n" : "") + "    movToCpuFromReg(offsetof(CPU, result.u8), DYN_DEST, DYN_8bit);" + (result ? "\r\n    movToCpuFromReg(OFFSET_REG8(op->reg), DYN_DEST, DYN_8bit);" : "")+(flags?"\r\n    movToCpu(offsetof(CPU, lazyFlags), Dyn_PtrSize, (DYN_PTR_SIZE)" + "FLAGS_"+name.toUpperCase()+bits + ");":"");
        }
        arithbase(fos, fos_init, fos32, mixed + "R8R8", name+"r8r8", "FLAGS_"+name.toUpperCase()+bits, "*cpu->reg8[op->rm]", "*cpu->reg8[op->reg]", "*cpu->reg8[op->reg] = ", "", op, cf, result, false, bits, flags, dyn,"", false);

        if (result) {
            dyn = "if (!op->needsToSetFlags()) {\r\n        calculateEaa(op, DYN_ADDRESS);\r\n        movToRegFromCpu(DYN_SRC, OFFSET_REG8(op->reg), DYN_8bit);\r\n        "+(cf?"movToRegFromReg(DYN_CALL_RESULT, DYN_8bit, DYN_CALL_RESULT, DYN_32bit);\r\n        instRegReg('+', DYN_SRC, DYN_CALL_RESULT, DYN_8bit);\r\n        ":"")+"instMemReg('" + op + "', DYN_ADDRESS, DYN_SRC, DYN_8bit);\r\n    } else {\r\n        movToCpuFromCpu(offsetof(CPU, src.u8), OFFSET_REG8(op->reg), DYN_8bit, DYN_SRC);\r\n        calculateEaa(op, DYN_ADDRESS);\r\n        movToCpuFromMem(offsetof(CPU, dst.u8), DYN_8bit, DYN_ADDRESS);\r\n        instRegReg(\'"+op+"\', DYN_READ_RESULT, DYN_SRC, DYN_8bit);\r\n"+(cf?"        movToRegFromCpu(DYN_SRC, offsetof(CPU, oldCF), DYN_32bit);\r\n        movToRegFromReg(DYN_SRC, DYN_8bit, DYN_SRC, DYN_32bit);\r\n        instRegReg(\'" + op + "\', DYN_READ_RESULT, DYN_SRC, DYN_8bit);\r\n":"")+"        movToCpuFromReg(offsetof(CPU, result.u8), DYN_READ_RESULT, DYN_8bit);\r\n        movToMemFromReg(DYN_ADDRESS, DYN_READ_RESULT, DYN_8bit);"+(flags?"\r\n        movToCpu(offsetof(CPU, lazyFlags), Dyn_PtrSize, (DYN_PTR_SIZE)" + "FLAGS_"+name.toUpperCase()+bits + ");":"")+"\r\n    }";
        } else {
            dyn = "movToCpuFromCpu(offsetof(CPU, src.u8), OFFSET_REG8(op->reg), DYN_8bit, DYN_SRC);\r\n    calculateEaa(op, DYN_ADDRESS);\r\n    movToCpuFromMem(offsetof(CPU, dst.u8), DYN_8bit, DYN_ADDRESS);\r\n    instRegReg(\'"+op+"\', DYN_READ_RESULT, DYN_SRC, DYN_8bit);\r\n"+(cf?"    movToRegFromCpu(DYN_SRC, offsetof(CPU, oldCF), DYN_32bit);\r\n    movToRegFromReg(DYN_SRC, DYN_8bit, DYN_SRC, DYN_32bit);\r\n    instRegReg(\'" + op + "\', DYN_READ_RESULT, DYN_SRC, DYN_8bit);\r\n":"")+"    movToCpuFromReg(offsetof(CPU, result.u8), DYN_READ_RESULT, DYN_8bit);"+(result?"\r\n    movToMemFromReg(DYN_ADDRESS, DYN_READ_RESULT, DYN_8bit);":"")+(flags?"\r\n    movToCpu(offsetof(CPU, lazyFlags), Dyn_PtrSize, (DYN_PTR_SIZE)" + "FLAGS_"+name.toUpperCase()+bits + ");":"");
        }
        arithbase(fos, fos_init, fos32, mixed + "E8R8", name+"e8r8", "FLAGS_"+name.toUpperCase()+bits, "*cpu->reg8[op->reg]", "readb(eaa)", "writeb(eaa, ", ")", op, cf, result, true, bits, flags, dyn,"", false);

        if (hasRE) {
            if (result) {
                dyn = "if (!op->needsToSetFlags()) {\r\n        calculateEaa(op, DYN_ADDRESS);\r\n        "+(cf?"movToRegFromCpu(DYN_DEST, OFFSET_REG8(op->reg), DYN_8bit);\r\n        movToRegFromReg(DYN_CALL_RESULT, DYN_8bit, DYN_CALL_RESULT, DYN_32bit);\r\n        instRegReg('" + op + "', DYN_DEST, DYN_CALL_RESULT, DYN_8bit);\r\n        movFromMem(DYN_8bit, DYN_ADDRESS);\r\n        instRegReg('" + op + "', DYN_DEST, DYN_READ_RESULT, DYN_8bit);\r\n        movToCpuFromReg(OFFSET_REG8(op->reg), DYN_DEST, DYN_8bit);":"movFromMem(DYN_8bit, DYN_ADDRESS);\r\n        instCPUReg('" + op + "', OFFSET_REG8(op->reg), DYN_READ_RESULT, DYN_8bit);")+"\r\n    } else {\r\n        calculateEaa(op, DYN_ADDRESS);\r\n        movToCpuFromMem(offsetof(CPU, src.u8), DYN_8bit, DYN_ADDRESS);\r\n        movToCpuFromCpu(offsetof(CPU, dst.u8), OFFSET_REG8(op->reg), DYN_8bit, DYN_DEST);\r\n        instRegReg(\'" + op + "\', DYN_DEST, DYN_READ_RESULT, DYN_8bit);\r\n"+(cf?"        movToRegFromCpu(DYN_SRC, offsetof(CPU, oldCF), DYN_32bit);\r\n        movToRegFromReg(DYN_SRC, DYN_8bit, DYN_SRC, DYN_32bit);\r\n        instRegReg(\'" + op + "\', DYN_DEST, DYN_SRC, DYN_8bit);\r\n":"")+"        movToCpuFromReg(offsetof(CPU, result.u8), DYN_DEST, DYN_8bit);\r\n        movToCpuFromReg(OFFSET_REG8(op->reg), DYN_DEST, DYN_8bit);"+(flags?"\r\n        movToCpu(offsetof(CPU, lazyFlags), Dyn_PtrSize, (DYN_PTR_SIZE)" + "FLAGS_"+name.toUpperCase()+bits + ");":"")+"\r\n    }";
            } else {
                dyn = "calculateEaa(op, DYN_ADDRESS);\r\n    movToCpuFromMem(offsetof(CPU, src.u8), DYN_8bit, DYN_ADDRESS);\r\n    movToCpuFromCpu(offsetof(CPU, dst.u8), OFFSET_REG8(op->reg), DYN_8bit, DYN_DEST);\r\n    instRegReg(\'" + op + "\', DYN_DEST, DYN_READ_RESULT, DYN_8bit);\r\n"+(cf?"    movToRegFromCpu(DYN_SRC, offsetof(CPU, oldCF), DYN_32bit);\r\n    movToRegFromReg(DYN_SRC, DYN_8bit, DYN_SRC, DYN_32bit);\r\n    instRegReg(\'" + op + "\', DYN_DEST, DYN_SRC, DYN_8bit);\r\n":"")+"    movToCpuFromReg(offsetof(CPU, result.u8), DYN_DEST, DYN_8bit);"+(result?"\r\n    movToCpuFromReg(OFFSET_REG8(op->reg), DYN_DEST, DYN_8bit);":"")+(flags?"\r\n    movToCpu(offsetof(CPU, lazyFlags), Dyn_PtrSize, (DYN_PTR_SIZE)" + "FLAGS_"+name.toUpperCase()+bits + ");":"");
            }
            arithbase(fos, fos_init, fos32, mixed + "R8E8", name + "r8e8", "FLAGS_" + name.toUpperCase() + bits, "readb(eaa(cpu, op))", "*cpu->reg8[op->reg]", "*cpu->reg8[op->reg] = ", "", op, cf, result, false, bits, flags, dyn, "", false);
        }
        if (iform) {
            if (result) {
                dyn = "if (!op->needsToSetFlags()) {\r\n        "+(cf?"movToRegFromReg(DYN_CALL_RESULT, DYN_8bit, DYN_CALL_RESULT, DYN_32bit);\r\n        instRegImm('+', DYN_CALL_RESULT, DYN_8bit, op->imm);\r\n        instCPUReg('"+op+"', OFFSET_REG8(op->reg), DYN_CALL_RESULT, DYN_8bit);":"instCPUImm('" + op + "', OFFSET_REG8(op->reg), DYN_8bit, op->imm);")+"\r\n    } else {\r\n        movToCpu(offsetof(CPU, src.u8), DYN_8bit, op->imm);\r\n        movToCpuFromCpu(offsetof(CPU, dst.u8), OFFSET_REG8(op->reg), DYN_8bit, DYN_DEST);\r\n        instRegImm(\'" + op + "\', DYN_DEST, DYN_8bit, op->imm);\r\n" + (cf ? "        movToRegFromReg(DYN_CALL_RESULT, DYN_8bit, DYN_CALL_RESULT, DYN_32bit);\r\n        instRegReg(\'" + op + "\', DYN_DEST, DYN_CALL_RESULT, DYN_8bit);\r\n" : "") + "        movToCpuFromReg(offsetof(CPU, result.u8), DYN_DEST, DYN_8bit);\r\n        movToCpuFromReg(OFFSET_REG8(op->reg), DYN_DEST, DYN_8bit);"+(flags?"\r\n        movToCpu(offsetof(CPU, lazyFlags), Dyn_PtrSize, (DYN_PTR_SIZE)" + "FLAGS_"+name.toUpperCase()+bits + ");":"")+"\r\n    }";
            } else {
                dyn = "movToCpu(offsetof(CPU, src.u8), DYN_8bit, op->imm);\r\n    movToCpuFromCpu(offsetof(CPU, dst.u8), OFFSET_REG8(op->reg), DYN_8bit, DYN_DEST);\r\n    instRegImm('" + op + "', DYN_DEST, DYN_8bit, op->imm);\r\n" + (cf ? "    movToRegFromReg(DYN_CALL_RESULT, DYN_8bit, DYN_CALL_RESULT, DYN_32bit);\r\n    instRegReg(\'" + op + "\', DYN_DEST, DYN_CALL_RESULT, DYN_8bit);\r\n" : "") + "    movToCpuFromReg(offsetof(CPU, result.u8), DYN_DEST, DYN_8bit);" + (result ? "\r\n    movToCpuFromReg(OFFSET_REG8(op->reg), DYN_DEST, DYN_8bit);" : "")+(flags?"\r\n    movToCpu(offsetof(CPU, lazyFlags), Dyn_PtrSize, (DYN_PTR_SIZE)" + "FLAGS_"+name.toUpperCase()+bits + ");":"")+(flags?"\r\n    movToCpu(offsetof(CPU, lazyFlags), Dyn_PtrSize, (DYN_PTR_SIZE)" + "FLAGS_"+name.toUpperCase()+bits + ");":"");
            }
            arithbase(fos, fos_init, fos32, mixed + "R8I8", name + "8_reg", "FLAGS_" + name.toUpperCase() + bits, "op->imm", "*cpu->reg8[op->reg]", "*cpu->reg8[op->reg] = ", "", op, cf, result, false, bits, flags, dyn,"", false);

            if (result) {
                dyn = "if (!op->needsToSetFlags()) {\r\n        calculateEaa(op, DYN_ADDRESS);\r\n        "+(cf?"movToRegFromReg(DYN_CALL_RESULT, DYN_8bit, DYN_CALL_RESULT, DYN_32bit);\r\n          instRegImm('+', DYN_CALL_RESULT, DYN_8bit, op->imm);\r\n        instMemReg('"+op+"', DYN_ADDRESS, DYN_CALL_RESULT, DYN_8bit);":"instMemImm('"+op+"', DYN_ADDRESS, DYN_8bit, op->imm);")+"\r\n    } else {\r\n        movToCpu(offsetof(CPU, src.u8), DYN_8bit, op->imm);\r\n        calculateEaa(op, DYN_ADDRESS);\r\n        movToCpuFromMem(offsetof(CPU, dst.u8), DYN_8bit, DYN_ADDRESS);\r\n        instRegImm(\'" + op + "\', DYN_READ_RESULT, DYN_8bit, op->imm);\r\n"+(cf?"        movToRegFromCpu(DYN_SRC, offsetof(CPU, oldCF), DYN_32bit);\r\n        movToRegFromReg(DYN_SRC, DYN_8bit, DYN_SRC, DYN_32bit);\r\n        instRegReg(\'" + op + "\', DYN_READ_RESULT, DYN_SRC, DYN_8bit);\r\n":"")+"        movToCpuFromReg(offsetof(CPU, result.u8), DYN_READ_RESULT, DYN_8bit);\r\n        movToMemFromReg(DYN_ADDRESS, DYN_READ_RESULT, DYN_8bit);"+(flags?"\r\n        movToCpu(offsetof(CPU, lazyFlags), Dyn_PtrSize, (DYN_PTR_SIZE)" + "FLAGS_"+name.toUpperCase()+bits + ");":"")+"\r\n    }";
            } else {
                dyn = "movToCpu(offsetof(CPU, src.u8), DYN_8bit, op->imm);\r\n    calculateEaa(op, DYN_ADDRESS);\r\n    movToCpuFromMem(offsetof(CPU, dst.u8), DYN_8bit, DYN_ADDRESS);\r\n    instRegImm(\'" + op + "\', DYN_READ_RESULT, DYN_8bit, op->imm);\r\n"+(cf?"    movToRegFromCpu(DYN_SRC, offsetof(CPU, oldCF), DYN_32bit);\r\n    movToRegFromReg(DYN_SRC, DYN_8bit, DYN_SRC, DYN_32bit);\r\n    instRegReg(\'" + op + "\', DYN_READ_RESULT, DYN_SRC, DYN_8bit);\r\n":"")+"    movToCpuFromReg(offsetof(CPU, result.u8), DYN_READ_RESULT, DYN_8bit);"+(result?"\r\n    movToMemFromReg(DYN_ADDRESS, DYN_READ_RESULT, DYN_8bit);":"")+(flags?"\r\n    movToCpu(offsetof(CPU, lazyFlags), Dyn_PtrSize, (DYN_PTR_SIZE)" + "FLAGS_"+name.toUpperCase()+bits + ");":"");
            }
            arithbase(fos, fos_init, fos32, mixed + "E8I8", name + "8_mem", "FLAGS_" + name.toUpperCase() + bits, "op->imm", "readb(eaa)", "writeb(eaa, ", ")", op, cf, result, true, bits, flags, dyn,"", false);
        }
    }
