...
public class Strings extends Base {
    ...
    public void movs(FileOutputStream fos, FileOutputStream fos_h, FileOutputStream fos_op, FileOutputStream fos_init, FileOutputStream fos32, String name, String bits, String SI, String DI, String CX, int inc) throws  IOException {
        ...
        out(fos32, "            callHostFunction(NULL, "+name+"16r, false, false, false, 2, 0, DYN_PARAM_CPU, op->base, DYN_PARAM_CONST_32);");
        out(fos32, "        } else { ");
        out(fos32, "            callHostFunction(NULL, "+name+"16, false, false, false, 2, 0, DYN_PARAM_CPU, op->base, DYN_PARAM_CONST_32);");
        out(fos32, "        }");
        out(fos32, "    } else { ");
        out(fos32, "        if (op->repZero || op->repNotZero) {");
        out(fos32, "            callHostFunction(NULL, "+name+"32r, false, false, false, 2, 0, DYN_PARAM_CPU, op->base, DYN_PARAM_CONST_32);");
        out(fos32, "        } else { ");
        out(fos32, "            callHostFunction(NULL, "+name+"32, false, false, false, 2, 0, DYN_PARAM_CPU, op->base, DYN_PARAM_CONST_32);");
        out(fos32, "        }");
        out(fos32, "    }");
    ...
    public void cmps(FileOutputStream fos, FileOutputStream fos_h, FileOutputStream fos_op, FileOutputStream fos_init, FileOutputStream fos32, String name, String width, String bits, String SI, String DI, String CX, int inc) throws  IOException {
        ...
        out(fos32, "    if (op->ea16) {");
        out(fos32, "        if (op->repZero || op->repNotZero) {");
        out(fos32, "            callHostFunction(NULL, "+name+"16r, false, false, false, 3, 0, DYN_PARAM_CPU, op->repZero, DYN_PARAM_CONST_32, op->base, DYN_PARAM_CONST_32);");
        out(fos32, "        } else { ");
        out(fos32, "            callHostFunction(NULL, "+name+"16, false, false, false, 3, 0, DYN_PARAM_CPU, op->repZero, DYN_PARAM_CONST_32, op->base, DYN_PARAM_CONST_32);");
        out(fos32, "        }");
        out(fos32, "    } else { ");
        out(fos32, "        if (op->repZero || op->repNotZero) {");
        out(fos32, "            callHostFunction(NULL, "+name+"32r, false, false, false, 3, 0, DYN_PARAM_CPU, op->repZero, DYN_PARAM_CONST_32, op->base, DYN_PARAM_CONST_32);");
        out(fos32, "        } else { ");
        out(fos32, "            callHostFunction(NULL, "+name+"32, false, false, false, 3, 0, DYN_PARAM_CPU, op->repZero, DYN_PARAM_CONST_32, op->base, DYN_PARAM_CONST_32);");
        out(fos32, "        }");
        out(fos32, "    }");
        out(fos32, "    INCREMENT_EIP(op->len);");
        out(fos32, "}");
    ...
    public void scas(FileOutputStream fos, FileOutputStream fos_h, FileOutputStream fos_op, FileOutputStream fos_init, FileOutputStream fos32, String name, String width, String bits, String AX, String DI, String CX, int inc) throws  IOException {
        ...
        out(fos32, "    if (op->ea16) {");
        out(fos32, "        if (op->repZero || op->repNotZero) {");
        out(fos32, "            callHostFunction(NULL, "+name+"16r, false, false, false, 2, 0, DYN_PARAM_CPU, op->repZero, DYN_PARAM_CONST_32);");
        out(fos32, "        } else { ");
        out(fos32, "            callHostFunction(NULL, "+name+"16, false, false, false, 2, 0, DYN_PARAM_CPU, op->repZero, DYN_PARAM_CONST_32);");
        out(fos32, "        }");
        out(fos32, "    } else { ");
        out(fos32, "        if (op->repZero || op->repNotZero) {");
        out(fos32, "            callHostFunction(NULL, "+name+"32r, false, false, false, 2, 0, DYN_PARAM_CPU, op->repZero, DYN_PARAM_CONST_32);");
        out(fos32, "        } else { ");
        out(fos32, "            callHostFunction(NULL, "+name+"32, false, false, false, 2, 0, DYN_PARAM_CPU, op->repZero, DYN_PARAM_CONST_32);");
        out(fos32, "        }");
        out(fos32, "    }");
        out(fos32, "    INCREMENT_EIP(op->len);");
        out(fos32, "}");
    ...
    public void stos(FileOutputStream fos, FileOutputStream fos_h, FileOutputStream fos_op, FileOutputStream fos_init, FileOutputStream fos32, String name, String bits, String DI, String CX, String AX, int inc) throws  IOException {
        ...
        out(fos32, "    if (op->ea16) {");
        out(fos32, "        if (op->repZero || op->repNotZero) {");
        out(fos32, "            callHostFunction(NULL, "+name+"16r, false, false, false, 1, 0, DYN_PARAM_CPU);");
        out(fos32, "        } else { ");
        out(fos32, "            callHostFunction(NULL, "+name+"16, false, false, false, 1, 0, DYN_PARAM_CPU);");
        out(fos32, "        }");
        out(fos32, "    } else { ");
        out(fos32, "        if (op->repZero || op->repNotZero) {");
        out(fos32, "            callHostFunction(NULL, "+name+"32r, false, false, false, 1, 0, DYN_PARAM_CPU);");
        out(fos32, "        } else { ");
        out(fos32, "            callHostFunction(NULL, "+name+"32, false, false, false, 1, 0, DYN_PARAM_CPU);");
        out(fos32, "        }");
        out(fos32, "    }");
        out(fos32, "    INCREMENT_EIP(op->len);");
        out(fos32, "}");
