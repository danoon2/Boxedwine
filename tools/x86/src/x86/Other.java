...
public class Other extends Base {
    ...
    public void generateAll(FileOutputStream fos, FileOutputStream fos_init, FileOutputStream fos32, FileOutputStream fosOps_h, FileOutputStream fosOps_cpp) throws IOException {
        ...
        inst(fos, fos_init, "retf16", "Retf16", "cpu->eip.u32+=op->len; cpu->ret(0, op->imm);\r\n    NEXT_DONE();", fos32, fosOps_h, fosOps_cpp, "", "", "movToRegFromCpu(DYN_SRC, offsetof(CPU, eip.u32), DYN_32bit);\r\n    instRegImm('+', DYN_SRC, DYN_32bit, op->len);\r\n    movToCpuFromReg(offsetof(CPU, eip.u32), DYN_SRC, DYN_32bit);\r\n    callHostFunction(common_ret, false, false, false, 3, 0, DYN_PARAM_CPU, 1, DYN_PARAM_CONST_32, 0, DYN_PARAM_CONST_32, op->imm, DYN_PARAM_CONST_32);", false, false);
        inst(fos, fos_init, "retf32", "Retf32", "cpu->eip.u32+=op->len; cpu->ret(1, op->imm);\r\n    NEXT_DONE();", fos32, fosOps_h, fosOps_cpp, "", "", "movToRegFromCpu(DYN_SRC, offsetof(CPU, eip.u32), DYN_32bit);\r\n    instRegImm('+', DYN_SRC, DYN_32bit, op->len);\r\n    movToCpuFromReg(offsetof(CPU, eip.u32), DYN_SRC, DYN_32bit);\r\n    callHostFunction(common_ret, false, false, false, 3, 0, DYN_PARAM_CPU, 1, DYN_PARAM_CONST_32, 1, DYN_PARAM_CONST_32, op->imm, DYN_PARAM_CONST_32);", false, false);
        ...
        inst(fos, fos_init, "enter16", "Enter16", "cpu->enter(0, op->imm, op->reg);\r\n    NEXT();", fos32, fosOps_h, fosOps_cpp, "", "", "callHostFunction(common_enter, true, false, false, 1, 0, DYN_PARAM_CPU, 0, DYN_PARAM_CONST_32, op->imm, DYN_PARAM_CONST_32, op->reg, DYN_PARAM_CONST_32);", true, false);
        inst(fos, fos_init, "enter32", "Enter32", "cpu->enter(1, op->imm, op->reg);\r\n    NEXT();", fos32, fosOps_h, fosOps_cpp, "", "", "callHostFunction(common_enter, true, false, false, 1, 0, DYN_PARAM_CPU, 1, DYN_PARAM_CONST_32, op->imm, DYN_PARAM_CONST_32, op->reg, DYN_PARAM_CONST_32);", true, false);
