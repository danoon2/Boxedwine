...
public class Other extends Base {
    ...
    public void generateAll(FileOutputStream fos, FileOutputStream fos_init, FileOutputStream fos32, FileOutputStream fosOps_h, FileOutputStream fosOps_cpp) throws IOException {
        ...
        inst(fos, fos_init, "salc", "Salc", "if (cpu->getCF()) AL = 0xFF; else AL = 0;\r\n    NEXT();", fos32, fosOps_h, fosOps_cpp, "if (cpu->getCF()) AL = 0xFF; else AL = 0;", "", "callHostFunction(common_salc, false, 1, 0, DYN_PARAM_CPU, false);", true, false);
        ...
        inst(fos, fos_init, "cmc", "Cmc", "cpu->fillFlags();\r\n    cpu->setCF(!cpu->getCF());\r\n    NEXT();", fos32, fosOps_h, fosOps_cpp, "cpu->fillFlags();\r\n    cpu->setCF(!cpu->getCF());", "", "callHostFunction(common_cmc, false, 1, 0, DYN_PARAM_CPU, false);", true, false);
        inst(fos, fos_init, "clc", "Clc", "cpu->fillFlags();\r\n    cpu->removeCF();\r\n    NEXT();", fos32, fosOps_h, fosOps_cpp, "cpu->fillFlags();\r\n    cpu->removeCF();", "", "callHostFunction(common_clc, false, 1, 0, DYN_PARAM_CPU, false);", true, false);
        inst(fos, fos_init, "stc", "Stc", "cpu->fillFlags();\r\n    cpu->addCF();\r\n    NEXT();", fos32, fosOps_h, fosOps_cpp, "cpu->fillFlags();\r\n    cpu->addCF();", "", "callHostFunction(common_stc, false, 1, 0, DYN_PARAM_CPU, false);", true, false);

        inst(fos, fos_init, "cli", "Cli", "cpu->removeFlag(IF);\r\n    NEXT();", fos32, fosOps_h, fosOps_cpp, "cpu->removeFlag(IF);", "", "callHostFunction(common_cli, false, 1, 0, DYN_PARAM_CPU, false);", true, false);
        inst(fos, fos_init, "sti", "Sti", "cpu->addFlag(IF);\r\n    NEXT();", fos32, fosOps_h, fosOps_cpp, "cpu->addFlag(IF);", "", "callHostFunction(common_sti, false, 1, 0, DYN_PARAM_CPU, false);", true, false);
