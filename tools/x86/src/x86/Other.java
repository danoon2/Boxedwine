...
public class Other extends Base {
    ...
    public void generateAll(FileOutputStream fos, FileOutputStream fos_init, FileOutputStream fos32, FileOutputStream fosOps_h, FileOutputStream fosOps_cpp) throws IOException {
        ...
        inst(fos, fos_init, "daa", "Daa", "daa(cpu);\r\n    NEXT();", fos32, fosOps_h, fosOps_cpp, "", "", "callHostFunction(NULL, daa, false, false, false, 1, 0, DYN_PARAM_CPU, false);", true, false);
        inst(fos, fos_init, "das", "Das", "das(cpu);\r\n    NEXT();", fos32, fosOps_h, fosOps_cpp, "", "", "callHostFunction(NULL, das, false, false, false, 1, 0, DYN_PARAM_CPU, false);", true, false);
        inst(fos, fos_init, "aaa", "Aaa", "aaa(cpu);\r\n    NEXT();", fos32, fosOps_h, fosOps_cpp, "", "", "callHostFunction(NULL, aaa, false, false, false, 1, 0, DYN_PARAM_CPU, false);", true, false);
        inst(fos, fos_init, "aas", "Aas", "aas(cpu);\r\n    NEXT();", fos32, fosOps_h, fosOps_cpp, "", "", "callHostFunction(NULL, aas, false, false, false, 1, 0, DYN_PARAM_CPU, false);", true, false);
        inst(fos, fos_init, "aad", "Aad", "aad(cpu, op->imm);\r\n    NEXT();", fos32, fosOps_h, fosOps_cpp, "", "", "callHostFunction(NULL, aad, false, false, false, 2, 0, DYN_PARAM_CPU, false, op->imm, DYN_PARAM_CONST_32, false);", true, false);
        inst(fos, fos_init, "aam", "Aam", "if (aam(cpu, op->imm)) {\r\n        NEXT();\r\n    } else {\r\n        NEXT_DONE();\r\n    }", fos32, fosOps_h, fosOps_cpp, "", "", "callHostFunction(blockDone, aam, true, false, true, 2, 0, DYN_PARAM_CPU, false, op->imm, DYN_PARAM_CONST_32, false);", true, false);
        ...
        inst(fos, fos_init, "cwd", "Cwd", "if (((S16)AX) < 0)\r\n        DX = 0xFFFF;\r\n    else\r\n        DX = 0;\r\n    NEXT();", fos32, fosOps_h, fosOps_cpp, "if (((S16)AX) < 0) {\r\n        DX = 0xFFFF;\r\n    } else {\r\n        DX = 0;\r\n    }", "", "callHostFunction(NULL, common_cwd, false, false, false, 1, 0, DYN_PARAM_CPU, false);", true, false);
        inst(fos, fos_init, "cwq", "Cwq", "if (((S32)EAX) < 0)\r\n        EDX = 0xFFFFFFFF;\r\n    else\r\n        EDX = 0;\r\n    NEXT();", fos32, fosOps_h, fosOps_cpp, "if (((S32)EAX) < 0) {\r\n        EDX = 0xFFFFFFFF;\r\n    } else {\r\n        EDX = 0;\r\n    }", "", "callHostFunction(NULL, common_cwq, false, false, false, 1, 0, DYN_PARAM_CPU, false);", true, false);
        ...
        inst(fos, fos_init, "sahf", "Sahf", "cpu->fillFlags(); cpu->setFlags(AH, FMASK_ALL & 0xFF);\r\n    NEXT();", fos32, fosOps_h, fosOps_cpp, "", "", "callHostFunction(NULL, common_fillFlags, false, false, false, 1, 0, DYN_PARAM_CPU, false);\r\n    callHostFunction(NULL, common_setFlags, false, false, false, 3, 0, DYN_PARAM_CPU, false, CPU_OFFSET_OF(reg[0].h8), DYN_PARAM_CPU_ADDRESS_8, false, FMASK_ALL & 0xFF, DYN_PARAM_CONST_32, false);", true, false);
        ...
        inst(fos, fos_init, "cmc", "Cmc", "cpu->fillFlags();\r\n    cpu->setCF(!cpu->getCF());\r\n    NEXT();", fos32, fosOps_h, fosOps_cpp, "cpu->fillFlags();\r\n    cpu->setCF(!cpu->getCF());", "", "callHostFunction(NULL, common_cmc, true, false, false, 1, 0, DYN_PARAM_CPU, false);", true, false);
        inst(fos, fos_init, "clc", "Clc", "cpu->fillFlags();\r\n    cpu->removeCF();\r\n    NEXT();", fos32, fosOps_h, fosOps_cpp, "cpu->fillFlags();\r\n    cpu->removeCF();", "", "callHostFunction(NULL, common_clc, true, false, false, 1, 0, DYN_PARAM_CPU, false);", true, false);
        inst(fos, fos_init, "stc", "Stc", "cpu->fillFlags();\r\n    cpu->addCF();\r\n    NEXT();", fos32, fosOps_h, fosOps_cpp, "cpu->fillFlags();\r\n    cpu->addCF();", "", "callHostFunction(NULL, common_stc, true, false, false, 1, 0, DYN_PARAM_CPU, false);", true, false);

        inst(fos, fos_init, "cli", "Cli", "cpu->removeFlag(IF);\r\n    NEXT();", fos32, fosOps_h, fosOps_cpp, "cpu->removeFlag(IF);", "", "callHostFunction(NULL, common_cli, true, false, false, 1, 0, DYN_PARAM_CPU, false);", true, false);
        inst(fos, fos_init, "sti", "Sti", "cpu->addFlag(IF);\r\n    NEXT();", fos32, fosOps_h, fosOps_cpp, "cpu->addFlag(IF);", "", "callHostFunction(NULL, common_sti, true, false, false, 1, 0, DYN_PARAM_CPU, false);", true, false);

        inst(fos, fos_init, "cld", "Cld", "cpu->removeFlag(DF);\r\n    cpu->df=1;\r\n    NEXT();", fos32, fosOps_h, fosOps_cpp, "cpu->removeFlag(DF);\r\n    cpu->df=1;", "", "callHostFunction(NULL, common_cld, true, false, false, 1, 0, DYN_PARAM_CPU, false);", true, false);
        inst(fos, fos_init, "std", "Std", "cpu->addFlag(DF);\r\n    cpu->df=-1;\r\n    NEXT();", fos32, fosOps_h, fosOps_cpp, "cpu->addFlag(DF);\r\n    cpu->df=-1;", "", "callHostFunction(NULL, common_std, true, false, false, 1, 0, DYN_PARAM_CPU, false);", true, false);

        inst(fos, fos_init, "rdtsc", "Rdtsc", "U64 t = cpu->instructionCount+op->imm;\r\n    EAX = (U32)t;\r\n    EDX = (U32)(t >> 32);\r\n    NEXT();", fos32, fosOps_h, fosOps_cpp, "", "", "callHostFunction(NULL, common_rdtsc, true, false, false, 2, 0, DYN_PARAM_CPU, false, op->imm, DYN_PARAM_CONST_32, false);", true, false);
        inst(fos, fos_init, "cpuid", "CPUID", "cpu->cpuid();\r\n    NEXT();", fos32, fosOps_h, fosOps_cpp, "cpu->cpuid();", "", "callHostFunction(NULL, common_cpuid, true, false, false, 1, 0, DYN_PARAM_CPU, false);", true, false);

        inst(fos, fos_init, "enter16", "Enter16", "cpu->enter(0, op->imm, op->reg);\r\n    NEXT();", fos32, fosOps_h, fosOps_cpp, "", "", "callHostFunction(NULL, common_enter, true, false, false, 4, 0, DYN_PARAM_CPU, false, 0, DYN_PARAM_CONST_32, false, op->imm, DYN_PARAM_CONST_32, false, op->reg, DYN_PARAM_CONST_32, false);", true, false);
        inst(fos, fos_init, "enter32", "Enter32", "cpu->enter(1, op->imm, op->reg);\r\n    NEXT();", fos32, fosOps_h, fosOps_cpp, "", "", "callHostFunction(NULL, common_enter, true, false, false, 4, 0, DYN_PARAM_CPU, false, 1, DYN_PARAM_CONST_32, false, op->imm, DYN_PARAM_CONST_32, false, op->reg, DYN_PARAM_CONST_32, false);", true, false);
    ...
    public void bound(FileOutputStream fos, FileOutputStream fos_init, String bits, String width, String offset, FileOutputStream fos32, FileOutputStream fosOps_h, FileOutputStream fosOps_cpp) throws IOException {
        ...
        out(fos32, "    callHostFunction(blockDone, common_bound"+bits+", true, false, true, 3, 0, DYN_PARAM_CPU, false, op->reg, DYN_PARAM_CONST_32, false, DYN_ADDRESS, DYN_PARAM_REG_32, true);");
    ...
    public void loadSeg(FileOutputStream fos, FileOutputStream fos_init, FileOutputStream fos32, String name, String ename, String bits, String width, String offset) throws IOException {
        ...
        out(fos32, "    callHostFunction(blockDone, common_setSegment, true, false, true, 3, 0, DYN_PARAM_CPU, false, op->imm, DYN_PARAM_CONST_32, false, DYN_CALL_RESULT, DYN_PARAM_REG_16, true);");
