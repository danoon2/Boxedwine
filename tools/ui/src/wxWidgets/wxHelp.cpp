...
HelpDialog::HelpDialog(wxWindow* parent) : wxDialog(parent, -1, "Help") {
    ...
    vbox->Add(new wxStaticText(this, -1, "Version: 19R1", wxDefaultPosition, wxDefaultSize), wxSizerFlags().DoubleBorder());
    ...
    vbox->Add(hbox2);
    vbox->Add(new wxStaticText(this, -1, "Install:\r\nYou can tap the button or drag the app you want to install onto Boxedwine.\r\n\r\nApps:\r\nYou can see more options, like Settings, on the apps by right-clicking them\r\n\r\nContainers:\r\nYou can see more options, like Settings and Delete, on the containers by right-clicking them", wxDefaultPosition, wxDefaultSize), wxSizerFlags().DoubleBorder());
    vbox->AddSpacer(20);
