...
**September 14 published package:** psVoodoo is now built from committed revision `67fcb0a0eb1be9c5f77d04250ad715b2f481754b`, which replaces the proprietary-worded SDK headers with explicitly licensed upstream headers. The source build pin has been updated. A fresh download from boxedwine.org differed from the app's existing package pin in six WebGL DLLs; the updated package preserves all six. Its only changes to existing entries are `glide2x.dll` and `changes.txt`, with source/license/build materials added under `/usr/local/share/doc/psvoodoo`. After the user's upload, a fresh download matched the tested archive byte for byte and passed native package validation. The app now pins **167,173,559 bytes**, SHA-256 `08cf3f51db0b0d00d9895763cd51a13ee6eaddd0e0a7bfb1f93cdbf2463cb079`. See [the filesystem update record](Licensing/psvoodoo-filesystem-update.json).

**Catalog integration history:** release `26R2-native-preview-5` includes Descent 3, Motorhead, and F-16. The September 13 Wine 11 package was 167,016,911 bytes, SHA-256 `a3367c4e977dbbe0295ce3b4b102bf7b0baa1278ea121cefe6065d561b960452`. It contained the final F-16-tested `glide2x.dll` (904,192 bytes, SHA-256 `55aee80ac08478f8d965cede9e07b011fa046ec02f84ebc18e78b1abaf44a939`), including the shadow fix from psVoodoo commit `e83947c2f4d800831db0643ad589fba1c98b2457`. The September 12 refresh changed only that Glide DLL. The September 13 refresh changed only CNC DDraw; the Glide DLL stayed identical. The native helper includes the matching filesystem-11 graphics ABI. The experiments below describe the package and overlays available at each stage.
