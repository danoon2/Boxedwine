...
bin/boxedwine -nosound -novideo -automation "$(pwd)/auto/abiword/play" -root "$(pwd)/auto/abiword/root" -zip "$(pwd)/auto/Wine-5.0.zip" -w /home/username/files/abiword /bin/wine /home/username/files/abiword/abiword
