...
void X86Asm::mem32(U8 inst, U8 dst, const Mem& mem, bool is64) {
...
void X86Asm::IfLessThan(Reg32 reg1, Reg32 reg2, bool bigJump) {
    cmp(reg1, reg2);
...
void X86Asm::IfLessThan(Reg16 reg1, Reg16 reg2, bool bigJump) {
    cmp(reg1, reg2);
...
void X86Asm::IfLessThan(Reg8 reg1, Reg8 reg2, bool bigJump) {
    cmp(reg1, reg2);
...
void X86Asm::IfEqual(Reg32 reg1, Reg32 reg2, bool bigJump) {
    cmp(reg1, reg2);
    IfZF(bigJump);
}

void X86Asm::IfEqual(Reg16 reg1, Reg16 reg2, bool bigJump) {
    cmp(reg1, reg2);
    IfZF(bigJump);
}

void X86Asm::IfEqual(Reg8 reg1, Reg8 reg2, bool bigJump) {
    cmp(reg1, reg2);
    IfZF(bigJump);
}
...
void X86Asm::IfNotEqual(Reg32 reg, Reg32 reg2, bool bigJump ) {
    cmp(reg, reg2);
    IfNotZF(bigJump);
}

void X86Asm::IfNotEqual(Reg16 reg, Reg16 reg2, bool bigJump) {
    cmp(reg, reg2);
    IfNotZF(bigJump);
}

void X86Asm::IfNotEqual(Reg8 reg, Reg8 reg2, bool bigJump) {
    cmp(reg, reg2);
    IfNotZF(bigJump);
}
...
void X86Asm::IfNotZF(bool bigJump) {
    if (bigJump) {
        outb(0x0f);
        outb(0x84); // jz
        ifJump.push_back((U32)buffer.size());
...
void X86Asm::IfBitSet(Reg32 reg, Reg32 mask, bool bigJump) {
    test(reg, mask);
    IfNotZF(bigJump);
}
...
#ifdef BOXEDWINE_64
void X86Asm::IfNotZero(Reg64 reg, bool bigJump) {
    test(reg, reg);
    if (bigJump) {
        outb(0x0f);
        outb(0x84); // jz
...
void X86Asm::IfNotEqual(Reg64 reg, Reg64 reg2, bool bigJump) {
    cmp(reg, reg2);
    IfNotZF(bigJump);
}

void X86Asm::IfEqual(Reg64 reg, Reg64 reg2, bool bigJump) {
    cmp(reg, reg2);
    IfZF(bigJump);
}
