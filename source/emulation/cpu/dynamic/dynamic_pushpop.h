void OPCALL dynamic_pushEw_reg(CPU* cpu, DecodedOp* op) {
    callHostFunction(NULL, common_push16, false, false, false, 2, 0, DYN_PARAM_CPU, false, CPU_OFFSET_OF(reg[op->reg].u16), DYN_PARAM_CPU_ADDRESS_16, false);
...
void OPCALL dynamic_pushEw_mem(CPU* cpu, DecodedOp* op) {
    ...
    callHostFunction(NULL, common_push16, false, false, false, 2, 0, DYN_PARAM_CPU, false, DYN_CALL_RESULT, DYN_PARAM_REG_16, true);
    INCREMENT_EIP(op->len);
}
...
void OPCALL dynamic_pushEd_reg(CPU* cpu, DecodedOp* op) {
    callHostFunction(NULL, common_push32, false, false, false, 2, 0, DYN_PARAM_CPU, false, CPU_OFFSET_OF(reg[op->reg].u32), DYN_PARAM_CPU_ADDRESS_32, false);
    INCREMENT_EIP(op->len);
}
...
void OPCALL dynamic_pushEd_mem(CPU* cpu, DecodedOp* op) {
    ...
    callHostFunction(NULL, common_push32, false, false, false, 2, 0, DYN_PARAM_CPU, false, DYN_CALL_RESULT, DYN_PARAM_REG_32, true);
    INCREMENT_EIP(op->len);
}
...
void OPCALL dynamic_pushSeg16(CPU* cpu, DecodedOp* op) {
    callHostFunction(blockDone, common_push16, false, false, false, 2, 0, DYN_PARAM_CPU, false, CPU_OFFSET_OF(seg[op->reg].value), DYN_PARAM_CPU_ADDRESS_16, false);
    INCREMENT_EIP(op->len);
}
void OPCALL dynamic_popSeg16(CPU* cpu, DecodedOp* op) {
    callHostFunction(NULL, common_peek16, true, false, false, 2, 0, DYN_PARAM_CPU, false, 0, DYN_PARAM_CONST_32, false);
...
void OPCALL dynamic_pushSeg32(CPU* cpu, DecodedOp* op) {
    callHostFunction(blockDone, common_push32, false, false, false, 2, 0, DYN_PARAM_CPU, false, CPU_OFFSET_OF(seg[op->reg].value), DYN_PARAM_CPU_ADDRESS_32, false);
    INCREMENT_EIP(op->len);
}
void OPCALL dynamic_popSeg32(CPU* cpu, DecodedOp* op) {
    callHostFunction(NULL, common_peek32, true, false, false, 2, 0, DYN_PARAM_CPU, false, 0, DYN_PARAM_CONST_32, false);
    callHostFunction(blockDone, common_setSegment, true, false, true, 3, 0, DYN_PARAM_CPU, false, op->reg, DYN_PARAM_CONST_32, false, DYN_CALL_RESULT, DYN_PARAM_REG_32, true);
    movToRegFromCpu(DYN_DEST, CPU_OFFSET_OF(stackMask), DYN_32bit);
    movToRegFromCpu(DYN_SRC, CPU_OFFSET_OF(reg[4].u32), DYN_32bit);
    movToRegFromReg(DYN_ADDRESS, DYN_32bit, DYN_SRC, DYN_32bit, false);
...
void OPCALL dynamic_pushA16(CPU* cpu, DecodedOp* op) {
    callHostFunction(NULL, common_pushA16, false, false, false, 1, 0, DYN_PARAM_CPU, false);
    INCREMENT_EIP(op->len);
}
void OPCALL dynamic_pushA32(CPU* cpu, DecodedOp* op) {
    callHostFunction(NULL, common_pushA32, false, false, false, 1, 0, DYN_PARAM_CPU, false);
    INCREMENT_EIP(op->len);
}
void OPCALL dynamic_popA16(CPU* cpu, DecodedOp* op) {
    callHostFunction(NULL, common_popA16, false, false, false, 1, 0, DYN_PARAM_CPU, false);
    INCREMENT_EIP(op->len);
}
void OPCALL dynamic_popA32(CPU* cpu, DecodedOp* op) {
    callHostFunction(NULL, common_popA32, false, false, false, 1, 0, DYN_PARAM_CPU, false);
    INCREMENT_EIP(op->len);
}
void OPCALL dynamic_push16imm(CPU* cpu, DecodedOp* op) {
    callHostFunction(NULL, common_push16, false, false, false, 2, 0, DYN_PARAM_CPU, false, op->imm, DYN_PARAM_CONST_16, false);
    INCREMENT_EIP(op->len);
}
void OPCALL dynamic_push32imm(CPU* cpu, DecodedOp* op) {
    callHostFunction(NULL, common_push32, false, false, false, 2, 0, DYN_PARAM_CPU, false, op->imm, DYN_PARAM_CONST_32, false);
    INCREMENT_EIP(op->len);
}
void OPCALL dynamic_popf16(CPU* cpu, DecodedOp* op) {
    movToCpu(CPU_OFFSET_OF(lazyFlags), Dyn_PtrSize, (DYN_PTR_SIZE)FLAGS_NONE);
    callHostFunction(NULL, common_pop16, true, false, false, 1, 0, DYN_PARAM_CPU, false);
    callHostFunction(NULL, common_setFlags, false, false, false, 3, 0, DYN_PARAM_CPU, false, DYN_CALL_RESULT, DYN_PARAM_REG_16, true, FMASK_ALL & 0xFFFF, DYN_PARAM_CONST_16, false);
    INCREMENT_EIP(op->len);
}
void OPCALL dynamic_popf32(CPU* cpu, DecodedOp* op) {
    movToCpu(CPU_OFFSET_OF(lazyFlags), Dyn_PtrSize, (DYN_PTR_SIZE)FLAGS_NONE);
    callHostFunction(NULL, common_pop32, true, false, false, 1, 0, DYN_PARAM_CPU, false);
    callHostFunction(NULL, common_setFlags, false, false, false, 3, 0, DYN_PARAM_CPU, false, DYN_CALL_RESULT, DYN_PARAM_REG_32, true, FMASK_ALL, DYN_PARAM_CONST_32, false);
    INCREMENT_EIP(op->len);
}
