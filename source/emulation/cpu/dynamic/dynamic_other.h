...
void DynamicData::dynamic_xaddr8r8(DecodedOp* op) {
    dynamic_RR_WriteBoth(op, JitWidth::b8, & DynamicData::xaddReg, FLAGS_ADD8);
}
void DynamicData::dynamic_xaddr8e8(DecodedOp* op) {
    dynamic_RM_WriteM(op, JitWidth::b8, &DynamicData::xaddReg, FLAGS_ADD8);
}
void DynamicData::dynamic_xaddr16r16(DecodedOp* op) {
    dynamic_RR_WriteBoth(op, JitWidth::b16, &DynamicData::xaddReg, FLAGS_ADD16);
}
void DynamicData::dynamic_xaddr16e16(DecodedOp* op) {
    dynamic_RM_WriteM(op, JitWidth::b16, &DynamicData::xaddReg, FLAGS_ADD16);
}
void DynamicData::dynamic_xaddr32r32(DecodedOp* op) {
    dynamic_RR_WriteBoth(op, JitWidth::b32, &DynamicData::xaddReg, FLAGS_ADD32);
}
void DynamicData::dynamic_xaddr32e32(DecodedOp* op) {
    dynamic_RM_WriteM(op, JitWidth::b32, &DynamicData::xaddReg, FLAGS_ADD32);
}
