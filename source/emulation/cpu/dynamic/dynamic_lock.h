...
void DynamicData::dynamic_btse32r32_lock(DecodedOp* op) {
    call_RR(common_btse32r32_lock, DYN_32bit, calculateEffectiveEaa32(op), DYN_32bit, calculateMask32(op));
    incrementEip(op->len);
    currentLazyFlags = nullptr;
}

void DynamicData::dynamic_btse16r16_lock(DecodedOp* op) {
    call_RR(common_btse16r16_lock, DYN_32bit, calculateEffectiveEaa16(op), DYN_32bit, calculateMask16(op));
    incrementEip(op->len);
    currentLazyFlags = nullptr;
}
...
void DynamicData::dynamic_btre32r32_lock(DecodedOp* op) {
    call_RR(common_btre32r32_lock, DYN_32bit, calculateEffectiveEaa32(op), DYN_32bit, calculateMask32(op));
    incrementEip(op->len);
    currentLazyFlags = nullptr;
}
void DynamicData::dynamic_btre16r16_lock(DecodedOp* op) {
    call_RR(common_btre16r16_lock, DYN_32bit, calculateEffectiveEaa16(op), DYN_32bit, calculateMask16(op));
    incrementEip(op->len);
    currentLazyFlags = nullptr;
}
...
void DynamicData::dynamic_btce32r32_lock(DecodedOp* op) {
    call_RR(common_btce32r32_lock, DYN_32bit, calculateEffectiveEaa32(op), DYN_32bit, calculateMask32(op));
    incrementEip(op->len);
    currentLazyFlags = nullptr;
}
void DynamicData::dynamic_btce16r16_lock(DecodedOp* op) {
    call_RR(common_btce16r16_lock, DYN_32bit, calculateEffectiveEaa16(op), DYN_32bit, calculateMask16(op));
    incrementEip(op->len);
    currentLazyFlags = nullptr;
}
