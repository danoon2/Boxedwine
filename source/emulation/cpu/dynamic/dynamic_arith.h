...
instCPU('~', CPU_OFFSET_OF_REG16(op->reg), DYN_16bit);
    INCREMENT_EIP(data, op);
}
...
instCPU('~', CPU_OFFSET_OF_REG32(op->reg), DYN_32bit);
    INCREMENT_EIP(data, op);
}
...
void dynamic_negr8(DynamicData* data, DecodedOp* op) {
    if (!op->needsToSetFlags()) {
        ...
        movToCpuLazyFlags(CPU_OFFSET_OF(lazyFlags), DYN_LAZY_FLAG(FLAGS_NEG8));
...
void dynamic_negr16(DynamicData* data, DecodedOp* op) {
    if (!op->needsToSetFlags()) {
        ...
        movToCpuFromCpu(CPU_OFFSET_OF(src.u16), CPU_OFFSET_OF_REG16(op->reg), DYN_16bit, DYN_DEST, false);
        ...
        movToCpuLazyFlags(CPU_OFFSET_OF(lazyFlags), DYN_LAZY_FLAG(FLAGS_NEG16));
...
void dynamic_negr32(DynamicData* data, DecodedOp* op) {
    if (!op->needsToSetFlags()) {
        ...
        movToCpuFromCpu(CPU_OFFSET_OF(src.u32), CPU_OFFSET_OF_REG32(op->reg), DYN_32bit, DYN_DEST, false);
        ...
        movToCpuLazyFlags(CPU_OFFSET_OF(lazyFlags), DYN_LAZY_FLAG(FLAGS_NEG32));
...
void dynamic_mulR8(DynamicData* data, DecodedOp* op) {
    callHostFunction(DYN_HOST_FN(common_mul8), false, 2, 0, DYN_PARAM_CPU, false, (DYN_PTR_SIZE)OFFSET_REG8(op->reg), DYN_PARAM_CPU_ADDRESS_8, false);
...
void dynamic_mulE8(DynamicData* data, DecodedOp* op) {
    ...
    callHostFunction(DYN_HOST_FN(common_mul8), false, 2, 0, DYN_PARAM_CPU, false, DYN_CALL_RESULT, DYN_PARAM_REG_8, true);
    data->currentLazyFlags=FLAGS_NONE;
    INCREMENT_EIP(data, op);
}
void dynamic_imulR8(DynamicData* data, DecodedOp* op) {
    callHostFunction(DYN_HOST_FN(common_imul8), false, 2, 0, DYN_PARAM_CPU, false, (DYN_PTR_SIZE)OFFSET_REG8(op->reg), DYN_PARAM_CPU_ADDRESS_8, false);
    data->currentLazyFlags=FLAGS_NONE;
    INCREMENT_EIP(data, op);
}
void dynamic_imulE8(DynamicData* data, DecodedOp* op) {
    calculateEaa(op, DYN_ADDRESS); movFromMem(DYN_8bit, DYN_ADDRESS, true);
    callHostFunction(DYN_HOST_FN(common_imul8), false, 2, 0, DYN_PARAM_CPU, false, DYN_CALL_RESULT, DYN_PARAM_REG_8, true);
    data->currentLazyFlags=FLAGS_NONE;
    INCREMENT_EIP(data, op);
}
void dynamic_mulR16(DynamicData* data, DecodedOp* op) {
    callHostFunction(DYN_HOST_FN(common_mul16), false, 2, 0, DYN_PARAM_CPU, false, (DYN_PTR_SIZE)CPU_OFFSET_OF_REG16(op->reg), DYN_PARAM_CPU_ADDRESS_16, false);
    INCREMENT_EIP(data, op);
}
void dynamic_mulE16(DynamicData* data, DecodedOp* op) {
    calculateEaa(op, DYN_ADDRESS); movFromMem(DYN_16bit, DYN_ADDRESS, true);
    callHostFunction(DYN_HOST_FN(common_mul16), false, 2, 0, DYN_PARAM_CPU, false, DYN_CALL_RESULT, DYN_PARAM_REG_16, true);
    INCREMENT_EIP(data, op);
}
void dynamic_imulR16(DynamicData* data, DecodedOp* op) {
    callHostFunction(DYN_HOST_FN(common_imul16), false, 2, 0, DYN_PARAM_CPU, false, (DYN_PTR_SIZE)CPU_OFFSET_OF_REG16(op->reg), DYN_PARAM_CPU_ADDRESS_16, false);
    INCREMENT_EIP(data, op);
}
void dynamic_imulE16(DynamicData* data, DecodedOp* op) {
    calculateEaa(op, DYN_ADDRESS); movFromMem(DYN_16bit, DYN_ADDRESS, true);
    callHostFunction(DYN_HOST_FN(common_imul16), false, 2, 0, DYN_PARAM_CPU, false, DYN_CALL_RESULT, DYN_PARAM_REG_16, true);
    INCREMENT_EIP(data, op);
}
void dynamic_mulR32(DynamicData* data, DecodedOp* op) {
    callHostFunction(DYN_HOST_FN(common_mul32), false, 2, 0, DYN_PARAM_CPU, false, (DYN_PTR_SIZE)CPU_OFFSET_OF_REG32(op->reg), DYN_PARAM_CPU_ADDRESS_32, false);
    INCREMENT_EIP(data, op);
}
void dynamic_mulE32(DynamicData* data, DecodedOp* op) {
    calculateEaa(op, DYN_ADDRESS); movFromMem(DYN_32bit, DYN_ADDRESS, true);
    callHostFunction(DYN_HOST_FN(common_mul32), false, 2, 0, DYN_PARAM_CPU, false, DYN_CALL_RESULT, DYN_PARAM_REG_32, true);
    INCREMENT_EIP(data, op);
}
void dynamic_imulR32(DynamicData* data, DecodedOp* op) {
    callHostFunction(DYN_HOST_FN(common_imul32), false, 2, 0, DYN_PARAM_CPU, false, (DYN_PTR_SIZE)CPU_OFFSET_OF_REG32(op->reg), DYN_PARAM_CPU_ADDRESS_32, false);
    INCREMENT_EIP(data, op);
}
void dynamic_imulE32(DynamicData* data, DecodedOp* op) {
    calculateEaa(op, DYN_ADDRESS); movFromMem(DYN_32bit, DYN_ADDRESS, true);
    callHostFunction(DYN_HOST_FN(common_imul32), false, 2, 0, DYN_PARAM_CPU, false, DYN_CALL_RESULT, DYN_PARAM_REG_32, true);
    INCREMENT_EIP(data, op);
}
void dynamic_divR8(DynamicData* data, DecodedOp* op) {
    callHostFunction(DYN_HOST_FN(div8), true, 2, 0, DYN_PARAM_CPU, false, (DYN_PTR_SIZE)OFFSET_REG8(op->reg), DYN_PARAM_CPU_ADDRESS_8, false);
...
void dynamic_divE8(DynamicData* data, DecodedOp* op) {
    calculateEaa(op, DYN_ADDRESS); movFromMem(DYN_8bit, DYN_ADDRESS, true);
    callHostFunction(DYN_HOST_FN(div8), true, 2, 0, DYN_PARAM_CPU, false, DYN_CALL_RESULT, DYN_PARAM_REG_8, true);
    startIf(DYN_CALL_RESULT, DYN_EQUALS_ZERO, true);
    blockDone();
    endIf();
    INCREMENT_EIP(data, op);
...
void dynamic_idivR8(DynamicData* data, DecodedOp* op) {
    ...
    callHostFunction(DYN_HOST_FN(idiv8), true, 2, 0, DYN_PARAM_CPU, false, DYN_SRC, DYN_PARAM_REG_32, true);
    startIf(DYN_CALL_RESULT, DYN_EQUALS_ZERO, true);
    blockDone();
    endIf();
    INCREMENT_EIP(data, op);
...
void dynamic_idivE8(DynamicData* data, DecodedOp* op) {
    ...
    callHostFunction(DYN_HOST_FN(idiv8), true, 2, 0, DYN_PARAM_CPU, false, DYN_CALL_RESULT, DYN_PARAM_REG_32, true);
    startIf(DYN_CALL_RESULT, DYN_EQUALS_ZERO, true);
    blockDone();
    endIf();
    INCREMENT_EIP(data, op);
...
void dynamic_divR16(DynamicData* data, DecodedOp* op) {
    callHostFunction(DYN_HOST_FN(div16), true, 2, 0, DYN_PARAM_CPU, false, (DYN_PTR_SIZE)CPU_OFFSET_OF_REG16(op->reg), DYN_PARAM_CPU_ADDRESS_16, false);
    startIf(DYN_CALL_RESULT, DYN_EQUALS_ZERO, true);
    blockDone();
    endIf();
    INCREMENT_EIP(data, op);
...
void dynamic_divE16(DynamicData* data, DecodedOp* op) {
    calculateEaa(op, DYN_ADDRESS); movFromMem(DYN_16bit, DYN_ADDRESS, true);
    callHostFunction(DYN_HOST_FN(div16), true, 2, 0, DYN_PARAM_CPU, false, DYN_CALL_RESULT, DYN_PARAM_REG_16, true);
    startIf(DYN_CALL_RESULT, DYN_EQUALS_ZERO, true);
    blockDone();
    endIf();
    INCREMENT_EIP(data, op);
...
void dynamic_idivR16(DynamicData* data, DecodedOp* op) {
    ...
    callHostFunction(DYN_HOST_FN(idiv16), true, 2, 0, DYN_PARAM_CPU, false, DYN_SRC, DYN_PARAM_REG_32, true);
    startIf(DYN_CALL_RESULT, DYN_EQUALS_ZERO, true);
    blockDone();
    endIf();
    INCREMENT_EIP(data, op);
...
void dynamic_idivE16(DynamicData* data, DecodedOp* op) {
    ...
    callHostFunction(DYN_HOST_FN(idiv16), true, 2, 0, DYN_PARAM_CPU, false, DYN_CALL_RESULT, DYN_PARAM_REG_32, true);
    startIf(DYN_CALL_RESULT, DYN_EQUALS_ZERO, true);
    blockDone();
    endIf();
    INCREMENT_EIP(data, op);
...
void dynamic_divR32(DynamicData* data, DecodedOp* op) {
    callHostFunction(DYN_HOST_FN(div32), true, 2, 0, DYN_PARAM_CPU, false, (DYN_PTR_SIZE)CPU_OFFSET_OF_REG32(op->reg), DYN_PARAM_CPU_ADDRESS_32, false);
    startIf(DYN_CALL_RESULT, DYN_EQUALS_ZERO, true);
    blockDone();
    endIf();
    INCREMENT_EIP(data, op);
...
void dynamic_divE32(DynamicData* data, DecodedOp* op) {
    calculateEaa(op, DYN_ADDRESS); movFromMem(DYN_32bit, DYN_ADDRESS, true);
    callHostFunction(DYN_HOST_FN(div32), true, 2, 0, DYN_PARAM_CPU, false, DYN_CALL_RESULT, DYN_PARAM_REG_32, true);
    startIf(DYN_CALL_RESULT, DYN_EQUALS_ZERO, true);
    blockDone();
    endIf();
    INCREMENT_EIP(data, op);
...
void dynamic_idivR32(DynamicData* data, DecodedOp* op) {
    callHostFunction(DYN_HOST_FN(idiv32), true, 2, 0, DYN_PARAM_CPU, false, (DYN_PTR_SIZE)CPU_OFFSET_OF_REG32(op->reg), DYN_PARAM_CPU_ADDRESS_32, false);
    startIf(DYN_CALL_RESULT, DYN_EQUALS_ZERO, true);
    blockDone();
    endIf();
    INCREMENT_EIP(data, op);
...
void dynamic_idivE32(DynamicData* data, DecodedOp* op) {
    calculateEaa(op, DYN_ADDRESS); movFromMem(DYN_32bit, DYN_ADDRESS, true);
    callHostFunction(DYN_HOST_FN(idiv32), true, 2, 0, DYN_PARAM_CPU, false, DYN_CALL_RESULT, DYN_PARAM_REG_32, true);
    startIf(DYN_CALL_RESULT, DYN_EQUALS_ZERO, true);
    blockDone();
    endIf();
    INCREMENT_EIP(data, op);
...
void dynamic_dimulcr16r16(DynamicData* data, DecodedOp* op) {
    ...
    callHostFunction(DYN_HOST_FN(common_dimul16), false, 4, 0, DYN_PARAM_CPU, false, DYN_DEST, DYN_PARAM_REG_16, true, op->imm, DYN_PARAM_CONST_16, false, op->reg, DYN_PARAM_CONST_32, false);
    data->currentLazyFlags=FLAGS_NONE;
    INCREMENT_EIP(data, op);
}
void dynamic_dimulcr16e16(DynamicData* data, DecodedOp* op) {
    calculateEaa(op, DYN_ADDRESS); movFromMem(DYN_16bit, DYN_ADDRESS, true);
    callHostFunction(DYN_HOST_FN(common_dimul16), false, 4, 0, DYN_PARAM_CPU, false, DYN_CALL_RESULT, DYN_PARAM_REG_16, true, op->imm, DYN_PARAM_CONST_16, false, op->reg, DYN_PARAM_CONST_32, false);
    data->currentLazyFlags=FLAGS_NONE;
    INCREMENT_EIP(data, op);
}
void dynamic_dimulcr32r32(DynamicData* data, DecodedOp* op) {
    movToRegFromCpu(DYN_DEST, CPU_OFFSET_OF_REG32(op->rm), DYN_32bit);
    callHostFunction(DYN_HOST_FN(common_dimul32), false, 4, 0, DYN_PARAM_CPU, false, DYN_DEST, DYN_PARAM_REG_32, true, op->imm, DYN_PARAM_CONST_32, false, op->reg, DYN_PARAM_CONST_32, false);
    data->currentLazyFlags=FLAGS_NONE;
    INCREMENT_EIP(data, op);
}
void dynamic_dimulcr32e32(DynamicData* data, DecodedOp* op) {
    calculateEaa(op, DYN_ADDRESS); movFromMem(DYN_32bit, DYN_ADDRESS, true);
    callHostFunction(DYN_HOST_FN(common_dimul32), false, 4, 0, DYN_PARAM_CPU, false, DYN_CALL_RESULT, DYN_PARAM_REG_32, true, op->imm, DYN_PARAM_CONST_32, false, op->reg, DYN_PARAM_CONST_32, false);
    data->currentLazyFlags=FLAGS_NONE;
    INCREMENT_EIP(data, op);
}
void dynamic_dimulr16r16(DynamicData* data, DecodedOp* op) {
    movToRegFromCpu(DYN_DEST, CPU_OFFSET_OF_REG16(op->rm), DYN_16bit);
    movToRegFromCpu(DYN_SRC, CPU_OFFSET_OF_REG16(op->reg), DYN_16bit);
    callHostFunction(DYN_HOST_FN(common_dimul16), false, 4, 0, DYN_PARAM_CPU, false, DYN_DEST, DYN_PARAM_REG_16, true, DYN_SRC, DYN_PARAM_REG_16, true, op->reg, DYN_PARAM_CONST_32, false);
    data->currentLazyFlags=FLAGS_NONE;
    INCREMENT_EIP(data, op);
}
void dynamic_dimulr16e16(DynamicData* data, DecodedOp* op) {
    calculateEaa(op, DYN_ADDRESS); movFromMem(DYN_16bit, DYN_ADDRESS, true);
    movToRegFromCpu(DYN_SRC, CPU_OFFSET_OF_REG16(op->reg), DYN_16bit);
    callHostFunction(DYN_HOST_FN(common_dimul16), false, 4, 0, DYN_PARAM_CPU, false, DYN_CALL_RESULT, DYN_PARAM_REG_16, true, DYN_SRC, DYN_PARAM_REG_16, true, op->reg, DYN_PARAM_CONST_32, false);
    data->currentLazyFlags=FLAGS_NONE;
    INCREMENT_EIP(data, op);
}
void dynamic_dimulr32r32(DynamicData* data, DecodedOp* op) {
    ...
    callHostFunction(DYN_HOST_FN(common_dimul32), false, 4, 0, DYN_PARAM_CPU, false, DYN_DEST, DYN_PARAM_REG_32, true, DYN_SRC, DYN_PARAM_REG_32, true, op->reg, DYN_PARAM_CONST_32, false);
    data->currentLazyFlags=FLAGS_NONE;
    INCREMENT_EIP(data, op);
}
void dynamic_dimulr32e32(DynamicData* data, DecodedOp* op) {
    calculateEaa(op, DYN_ADDRESS); movFromMem(DYN_32bit, DYN_ADDRESS, true);
    movToRegFromCpu(DYN_SRC, CPU_OFFSET_OF_REG32(op->reg), DYN_32bit);
    callHostFunction(DYN_HOST_FN(common_dimul32), false, 4, 0, DYN_PARAM_CPU, false, DYN_CALL_RESULT, DYN_PARAM_REG_32, true, DYN_SRC, DYN_PARAM_REG_32, true, op->reg, DYN_PARAM_CONST_32, false);
    data->currentLazyFlags=FLAGS_NONE;
    INCREMENT_EIP(data, op);
}
