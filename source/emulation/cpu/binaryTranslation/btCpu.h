...
public:
    BtCPU() : nativeHandle(0), exceptionAddress(0), inException(false), exceptionReadAddress(false), returnHostAddress(0), exceptionSigNo(0), exceptionSigCode(0), exceptionIp(0), eipToHostInstructionAddressSpaceMapping(NULL), memOffsets(NULL) {}
    U64 nativeHandle;
