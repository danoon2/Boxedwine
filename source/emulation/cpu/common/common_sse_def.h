...
SSE_RE(pmaxswMmxE64)
SSE_RR(pmaxswXmmXmm)
SSE_RE(pmaxswXmmE128)
SSE_RR(pmaxubMmxMmx)
SSE_RE(pmaxubMmxE64)
SSE_RR(pmaxubXmmXmm)
SSE_RE(pmaxubXmmE128)
SSE_RR(pminswMmxMmx)
SSE_RE(pminswMmxE64)
SSE_RR(pminswXmmXmm)
SSE_RE(pminswXmmE128)
SSE_RR(pminubMmxMmx)
SSE_RE(pminubMmxE64)
SSE_RR(pminubXmmXmm)
SSE_RE(pminubXmmE128)
SSE_RR(pmovmskbR32Mmx)
SSE_RE(pmovmskbR32Xmm)
SSE_RR(pmulhuwMmxMmx)
SSE_RE(pmulhuwMmxE64)
SSE_RR(pmulhuwXmmXmm)
SSE_RE(pmulhuwXmmE128)
