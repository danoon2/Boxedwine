...
void vk_CreateDescriptorUpdateTemplate(CPU* cpu) {
    VkDevice device = (VkDevice)getVulkanPtr(cpu->memory, ARG1);
    BoxedVulkanInfo* pBoxedInfo = getInfoFromHandle(cpu->memory, ARG1);
    std::shared_ptr<MarshalVkDescriptorUpdateTemplateCreateInfo> local_pCreateInfo = std::make_shared<MarshalVkDescriptorUpdateTemplateCreateInfo>(pBoxedInfo, cpu->memory, ARG2);
