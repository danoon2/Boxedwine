...
#define llARG1 readq(ARG1)
#define llARG2 readq(ARG2)
#define llARG3 readq(ARG3)
#define llARG4 readq(ARG4)
#define llARG5 readq(ARG5)
#define llARG6 readq(ARG6)
#define llARG7 readq(ARG7)
#define llARG8 readq(ARG8)
