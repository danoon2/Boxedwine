...
GL_FUNCTION(GetPolygonStipple, void, (GLubyte* mask), (p), GLubyte buffer[128] = { 0 }; GLboolean b = PIXEL_PACK_BUFFER(); GLubyte* p=nullptr; if (b)p = (GLubyte*)pARG1; else p = buffer; , if (!b) marshalBackub(cpu, ARG1, buffer, 128); , ("glGetPolygonStipple"))
...
GL_FUNCTION(GetPixelMapfv, void, (GLenum map, GLfloat *values), (ARG1, buffer), GLfloat* buffer=nullptr; GLboolean b = PIXEL_PACK_BUFFER(); if (b) buffer=(GLfloat*)pARG2; else buffer = marshalf(cpu, ARG2, glcommon_glGetPixelMap_size(ARG1));, if (!b) marshalBackf(cpu, ARG2, buffer, glcommon_glGetPixelMap_size(ARG1));,("glGetPixelMapfv"))
GL_FUNCTION(GetPixelMapuiv, void, (GLenum map, GLuint *values), (ARG1, buffer), GLuint* buffer=nullptr; GLboolean b = PIXEL_PACK_BUFFER(); if (b) buffer=(GLuint*)pARG2; else buffer = (GLuint*)marshali(cpu, ARG2, glcommon_glGetPixelMap_size(ARG1));, if (!b) marshalBacki(cpu, ARG2, (GLint*)buffer, glcommon_glGetPixelMap_size(ARG1));,("glGetPixelMapuiv"))
GL_FUNCTION(GetPixelMapusv, void, (GLenum map, GLushort *values), (ARG1, buffer), GLushort* buffer=nullptr; GLboolean b = PIXEL_PACK_BUFFER(); if (b) buffer=(GLushort*)pARG2; else buffer = marshalus(cpu, ARG2, glcommon_glGetPixelMap_size(ARG1));, if (!b) marshalBackus(cpu, ARG2, buffer, glcommon_glGetPixelMap_size(ARG1));,("glGetPixelMapusv"))
