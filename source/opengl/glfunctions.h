...
GL_FUNCTION(PrioritizeTextures, void, (GLsizei n, const GLuint *textures, const GLclampf *priorities), (ARG1, marshalArray<GLuint>(cpu, ARG2, ARG1), marshal2f(cpu, ARG3, ARG1)),,,("glPrioritizeTextures"))
...
GL_FUNCTION(GetPixelMapusv, void, (GLenum map, GLushort *values), (ARG1, buffer), GLushort* buffer=nullptr; GLboolean b = PIXEL_PACK_BUFFER(); if (b) buffer=(GLushort*)pARG2; else buffer = marshalArray<GLushort>(cpu, ARG2, glcommon_glGetPixelMap_size(ARG1));, if (!b) marshalBackArray<GLushort>(cpu, buffer, ARG2, glcommon_glGetPixelMap_size(ARG1));,("glGetPixelMapusv"))
