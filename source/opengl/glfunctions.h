...
GL_FUNCTION(Bitmap, void, (GLsizei width, GLsizei height, GLfloat xorig, GLfloat yorig, GLfloat xmove, GLfloat ymove, const GLubyte *bitmap), (ARG1, ARG2, fARG3, fARG4, fARG5, fARG6, PIXEL_UNPACK_BUFFER()?(GLubyte*)ARG7:(GLubyte*)marshalPixels(cpu, 0, ARG1, ARG2, 1, GL_COLOR_INDEX, GL_BITMAP, ARG7)),,,("glBitmap"))
...
GL_FUNCTION(GetPixelMapuiv, void, (GLenum map, GLuint *values), (ARG1, buffer), GLuint* buffer; GLboolean b = PIXEL_PACK_BUFFER(); if (b) buffer=(GLuint*)ARG2; else buffer = (GLuint*)marshali(cpu, ARG2, glcommon_glGetPixelMap_size(ARG1));, if (!b) marshalBacki(cpu, ARG2, (GLint*)buffer, glcommon_glGetPixelMap_size(ARG1));,("glGetPixelMapuiv"))
