...
#ifndef __KBROWSERSOCKET_H__
#define __KBROWSERSOCKET_H__
...
class KBrowserSocketObject : public KSocketObject {
public:
    KBrowserSocketObject(U32 domain, U32 type, U32 protocol);
    KBrowserSocketObject(U32 domain, U32 type, U32 protocol, U32 browserSocket);
    ~KBrowserSocketObject() override;
...
private:
    ...
    bool hasBrowserSocket() const;
    U32 networkUnavailable();
    U32 updateEvents();
    void refreshAddressMetadata();
    U32 finishBrowserResult(S32 result);
};
